...
function ClearInventory.Command(aIndex, Arguments)
    ...
    -- Bloqueio de jogador na Central de Segurança
	...
	if notEmpty == 0
	then
		SendMessage(string.format(CLEAR_INVENTORY_MESSAGES[Language][6]), aIndex, 26)
		return
	end
...
Commands.Register('/clear',	    ClearInventory.Command)
Commands.Register('/limparinv', ClearInventory.Command)
