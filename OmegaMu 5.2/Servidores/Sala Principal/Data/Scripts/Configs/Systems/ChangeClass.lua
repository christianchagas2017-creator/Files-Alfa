...
function ChangeClass.Command(aIndex, Arguments, Type)
	...
	for i = 0, 11 do
		if pInv:isItem(i) == 1
		then
			SendMessage(string.format(CHANGE_CLASS_MESSAGES[Language][7]), aIndex, 35)
			SendMessage(string.format(CHANGE_CLASS_MESSAGES[Language][8]), aIndex, 35)
			return
		end
	end
	...
	then
		...
		SendMessage(string.format(CHANGE_CLASS_MESSAGES[Language][10]), aIndex, 26)
	...
	then
		...
		SendMessage(string.format(CHANGE_CLASS_MESSAGES[Language][12]), aIndex, 26)
	...
	then
		...
		SendMessage(string.format(CHANGE_CLASS_MESSAGES[Language][14]), aIndex, 26)
	...
	then
		...
		SendMessage(string.format(CHANGE_CLASS_MESSAGES[Language][16]), aIndex, 26)
