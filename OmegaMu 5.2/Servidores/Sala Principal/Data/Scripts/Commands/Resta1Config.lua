...
CoordX	= 18,	-- Coordenada X onde ocorrerá o evento.
CoordY	= 23	-- Coordenada Y onde ocorrerá o evento.
} 
...
MoneyColumn		= "JcPoints", 		-- Coluna da moeda
MoneyWhere		= "memb___id", 	    -- Indentificador da conta
MoneyAmmount	= 1,				-- Quantidade da moeda
MoneyName		= "JcPoints",		-- Nome da moeda
...
RESTA1_STAFF_REWARD	= {
MoneyTable		= "MEMB_INFO",		-- Tabela da moeda
MoneyColumn		= "Events", 		-- Coluna da moeda
MoneyWhere		= "memb___id", 	    -- Indentificador da conta
MoneyAmmount	= 1,				-- Quantidade da moeda
MoneyName		= "Events",		-- Nome da moeda
PointsTable		= "Character", 		-- Tabela dos pontos
PointsColumn	= "resta1",	-- Coluna dos pontos
PointsWhere		= "Name",			-- Identificador do Char
PointsAmmount	= 0					-- Quantidade
...
MoneyColumn		= "JcPoints",			-- Coluna da moeda
MoneyWhere		= "memb___id",		-- Indentificador da conta
MoneyAmmount	= 500,				-- Quantidade da moeda
MoneyName		= "JcPoints",		    -- Nome da moeda
PointsTable		= "Character",		-- Tabela dos pontos
PointsColumn	= "resta1",	-- Coluna dos pontos
PointsWhere		= "Name",			-- Identificador do Char
