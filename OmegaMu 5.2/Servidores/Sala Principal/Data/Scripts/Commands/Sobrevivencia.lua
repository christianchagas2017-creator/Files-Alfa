...
SOBRE_DATA	= {
{_dayofweek = -1, _day = -1, _hour = 15, _minute = 40},
{_dayofweek = -1, _day = -1, _hour = 15, _minute = 43},
{_dayofweek = -1, _day = -1, _hour = 15, _minute = 45},
{_dayofweek = -1, _day = -1, _hour = 15, _minute = 48},
{_dayofweek = -1, _day = -1, _hour = 15, _minute = 51},
{_dayofweek = -1, _day = -1, _hour = 15, _minute = 54},
{_dayofweek = -1, _day = -1, _hour = 15, _minute = 57},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 00},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 03},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 06},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 09},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 12},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 15},
{_dayofweek = -1, _day = -1, _hour = 15, _minute = 55},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 00},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 05},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 10},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 15},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 20},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 25},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 30},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 35},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 40},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 45},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 50},
{_dayofweek = -1, _day = -1, _hour = 16, _minute = 55},
}
...
Map		= 2,	-- Mapa
CoordX	= 23,	-- Coordenada X -- coordenada X para onde o player sera movido ao entrar no evento
CoordY	= 11,	-- Coordenada Y	-- coordenada Y para onde o player sera movido ao entrar no evento
CoordX1	= 19,	-- Coordenada X Menor
CoordY1	= 5,	-- Coordenada Y Menor
CoordX2	= 28,	-- Coordenada X Maior
CoordY2	= 16	-- Coordenada Y Maior
} 


-- Configuração do premio
SOBRE_PREMIO_NOME = "JcPoints"			-- Nome da moeda
SOBRE_PREMIO_VALOR = 500				-- Quantidade da moeda
SOBRE_PREMIO_TABELA = "MEMB_INFO"	-- Tabela da moeda
SOBRE_PREMIO_COLUNA = "JcPoints"		-- Coluna da moeda
...
SOBRE_PREMIO_VALOR = 1				-- Quantidade da moeda
SOBRE_PREMIO_TABELA = "MEMB_INFO"	-- Tabela da moeda
