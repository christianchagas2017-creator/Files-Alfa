...
RESET_NPC_SWITCH = 0
RESET_NPC = { 
{Class = 249, Map = 0, CoordX = 125, CoordY = 125, Dir = 3},
...
RESET_ACUMULATIVE_LEVEL[0] = 400 -- RESET FREE
RESET_ACUMULATIVE_LEVEL[1] = 350 -- RESET VIP 
RESET_ACUMULATIVE_LEVEL[2] = 350 -- RESET VIP VOX
RESET_ACUMULATIVE_LEVEL[3] = 350
RESET_ACUMULATIVE_MONEY = {}
RESET_ACUMULATIVE_MONEY[0] = 800000
RESET_ACUMULATIVE_MONEY[1] = 800000
RESET_ACUMULATIVE_MONEY[2] = 500000
RESET_ACUMULATIVE_MONEY[3] = 500000
RESET_ACUMULATIVE_LEVEL_AFTER = {}
RESET_ACUMULATIVE_LEVEL_AFTER[0] = 1
RESET_ACUMULATIVE_LEVEL_AFTER[1] = 6
RESET_ACUMULATIVE_LEVEL_AFTER[2] = 6
RESET_ACUMULATIVE_LEVEL_AFTER[3] = 6

RESET_ACUMULATIVE_RETURN = {}

RESET_ACUMULATIVE_RETURN[0] = 0
RESET_ACUMULATIVE_RETURN[1] = 0
RESET_ACUMULATIVE_RETURN[2] = 0
RESET_ACUMULATIVE_RETURN[3] = 0
...
-- aqui configura quanto ganha a cada reset
RESET_ACUMULATIVE_RELOGAR = {}
RESET_ACUMULATIVE_RELOGAR[0] = 0  -- 0 = nao relogar
RESET_ACUMULATIVE_RELOGAR[1] = 0  -- 0 = nao relogar
RESET_ACUMULATIVE_RELOGAR[2] = 0  -- 0 = nao relogar
RESET_ACUMULATIVE_RELOGAR[3] = 0  -- 0 = nao relogar
RESET_ACUMULATIVE_RESETS = {}
RESET_ACUMULATIVE_RESETS[0] = 1
RESET_ACUMULATIVE_RESETS[1] = 1
RESET_ACUMULATIVE_RESETS[2] = 1
RESET_ACUMULATIVE_RESETS[3] = 1
...
RESET_TABLE_RETURN = {}
RESET_TABLE_RETURN[0] = 0
RESET_TABLE_RETURN[1] = 0
...
RESET_TABLE_POINTS_STATUS[3] = 25

ExpRewardValue = {}
ExpRewardValue[0] = 5   -- XP para jogadores Free
ExpRewardValue[1] = 10  -- XP para jogadores Vip
ExpRewardValue[2] = 50  -- XP para jogadores Vip1
ExpRewardValue[3] = 20  -- XP para jogadores Vip2
...
[15] = "Você ganhou %d de Experiência no BattlePass! (Total: %d)"
}
