...
function GuardiaoBrindes.Init()
	...
	InterfaceController.AfterMainProc(GuardiaoBrindes.AfterInterface)
...
function GuardiaoBrindes.Define()
	...
	GuardiaoBrindes_Config.TextArea = {onFocus = false, timer = 0, cursor = "|", selected = false}
	GuardiaoBrindes_Config.Codigo = ""	
	GuardiaoBrindes_Config.AlertWindow = {Show = false, Type = 0}
	GuardiaoBrindes_Config.CopiadoTimer = 0
	GuardiaoBrindes_Config.HiddenCode = true
	...
	GuardiaoBrindes_Config.Area = {sx = 260, ex = 450}
...
function GuardiaoBrindes.RequestOpen()
	local pname = string.format("15-%s-%d", UserGetName(), UserGetIndex())
	CreatePacket(pname, GuardiaoBrindes_Config.Packet)
	SendPacket(pname)
	ClearPacket(pname)
end
...
function GuardiaoBrindes.AfterInterface()
	...
	if GuardiaoBrindes_Config.Page == 0 or GuardiaoBrindes_Config.Page == 1 then
		if GuardiaoBrindes_Config.AlertWindow.Show then
			...
			RenderImage2(40040, 205+addX, 86, 225, 50, 0, 0, 0.93203125, 0.625, 1, 1, 1.0)
			RenderImage2(40063, 205+addX, 110, 225, 50, 0, 0, 0.93203125, 0.625, 1, 1, 1.0)
		
		
			GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.ok, 285+addX, 125, 60, 18)
			if GuardiaoBrindes.ButtonMouseOver(GuardiaoBrindes_Config.ButtonID.ok, MousePosX(), MousePosY()) then
				RenderImage2(40031, 285+addX, 125, 55, 21, 0.009000, 0.212000, 0.610000, 0.180000, 1, 1, 1.0)
			else
				RenderImage2(40031, 285+addX, 125, 55, 21, 0.009000, 0.012000, 0.610000, 0.180000, 1, 1, 1.0)
			end
			
			SetFontType(0)			
			SetTextBg(0, 0, 0, 0)				
			SetTextColor(255, 255, 255, 255)
			RenderText3(313+addX, 131, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][28]), 200, 8)
			...
			if GuardiaoBrindes_Config.AlertWindow.Type == 0 then
				...
				SetTextBg(0, 0, 0, 0)				
				SetTextColor(255, 255, 255, 255)
				RenderText3(320+addX, 95, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][20]), 200, 8)
				RenderText3(320+addX, 105, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][21]), 200, 8)
				DisableAlphaBlend()
				SetBlend(1)
				EndDrawBar()
			end
			...
			if GuardiaoBrindes_Config.AlertWindow.Type == 1 then
				...
				SetTextBg(0, 0, 0, 0)				
				SetTextColor(255, 255, 255, 255)
				RenderText3(320+addX, 100, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][23]), 200, 8)
				DisableAlphaBlend()
				SetBlend(1)
				EndDrawBar()
			end
		...
		if GuardiaoBrindes_Config.AlertWindow.Show then
			if GuardiaoBrindes_Config.AlertWindow.Type >= 0 then
				...
				if 	GuardiaoBrindes_Config.AlertWindow.Type < 2 then
					RenderText3(320+addX, 100, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][17]), 200, 8)
				end

				if GuardiaoBrindes_Config.AlertWindow.Type == 2 then
					RenderText3(320+addX, 100, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][18]), 200, 8)
				end

				if GuardiaoBrindes_Config.AlertWindow.Type == 3 then
					RenderText3(320+addX, 100, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][24]), 200, 8)
				end
				DisableAlphaBlend()
				SetBlend(1)
				EndDrawBar()
...
function GuardiaoBrindes.Interface()						
	...
	local offset = WindowGetWidth()-640
	EnableAlphaTest()
	RenderImage2(40046, 260+offset-GuardiaoBrindes_Config.WindowOffset, 0, 191, 429, 0.0, 1.0, 0.83, 0.935, 1, 1, 1.0)

	SetFontType(1)
	SetTextBg(0, 0, 0, 255)
	SetTextColor(255, 255, 255, 240)
	RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 12, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][1]), 80, 8)

	GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.fechar,470+offset, 395, 24, 24)
	GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.acessar,0,0,0,0)
	GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.meuscodigos,0,0,0,0)
	GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.textarea,0,0,0,0)
	GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.ok,0,0,0,0)
	GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.copiar,0,0,0,0)
	GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.hidden, 0,0,0,0)
	GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.back, 0,0,0,0)
	...
	if GuardiaoBrindes_Config.Page == 0 then		
		...
		--DrawBar(280-GuardiaoBrindes_Config.WindowOffset, 50, 150, 358)
		EndDrawBar()
		EnableAlphaTest(1)
		RenderImage2(40062, 283+offset-GuardiaoBrindes_Config.WindowOffset, 60, 140, 100, 0.002, 0.002, 0.82982659, 0.58181264, 1,1, 1.0)

		GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.acessar, 310+offset-GuardiaoBrindes_Config.WindowOffset, 330, 90, 25)
		...
		if GuardiaoBrindes.ButtonClicked(GuardiaoBrindes_Config.ButtonID.acessar) then
			stateAcessar = 2
		end
		DrawButton.Large(stateAcessar, 310+offset-GuardiaoBrindes_Config.WindowOffset, 330, 90, 25)

		GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.meuscodigos, 310+offset-GuardiaoBrindes_Config.WindowOffset, 368, 90, 25)
		local stateCodigos = 0
		...
		if GuardiaoBrindes.ButtonClicked(GuardiaoBrindes_Config.ButtonID.meuscodigos) then
			stateCodigos = 2
		end
		DrawButton.Large(stateCodigos, 310+offset-GuardiaoBrindes_Config.WindowOffset, 368, 90, 25)

		GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.textarea, 300+offset-GuardiaoBrindes_Config.WindowOffset, 290, 110, 20)
		DrawInterface.TextBox2(0, 300+offset-GuardiaoBrindes_Config.WindowOffset, 290, 110, 20)
		...
		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 171, GuardiaoBrindes_Config.Texts[GetLanguage()][2], 150, 8)
		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 181, GuardiaoBrindes_Config.Texts[GetLanguage()][25], 150, 8)

		SetFontType(0)
		SetTextBg(0, 0, 0, 0)
		SetTextColor(247, 239, 200, 255)
		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 200, GuardiaoBrindes_Config.Texts[GetLanguage()][3], 150, 8)
		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 210, GuardiaoBrindes_Config.Texts[GetLanguage()][4], 150, 8)
		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 220, GuardiaoBrindes_Config.Texts[GetLanguage()][5], 150, 8)
		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 230, GuardiaoBrindes_Config.Texts[GetLanguage()][26], 150, 8)

		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 260, GuardiaoBrindes_Config.Texts[GetLanguage()][6], 150, 8)
		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 270, GuardiaoBrindes_Config.Texts[GetLanguage()][7], 150, 8)

		RenderText3(315+offset-GuardiaoBrindes_Config.WindowOffset, 296, "                   ", 80, 1)
		if GuardiaoBrindes_Config.TextArea.selected then
			SetTextBg(100, 100, 100, 150)
		else
			SetTextBg(0, 0, 0, 0)
		end
		SetTextColor(255, 255, 255, 255)
		if GuardiaoBrindes_Config.TextArea.onFocus then
			if GuardiaoBrindes_Config.TextArea.timer >= 8 then
				...
				RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 296, GuardiaoBrindes_Config.Codigo, 90, 8)
			else
				if GuardiaoBrindes_Config.TextArea.selected then
					RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 296, GuardiaoBrindes_Config.Codigo, 90, 8)
				else
					RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 296, GuardiaoBrindes_Config.Codigo..GuardiaoBrindes_Config.TextArea.cursor,90, 8)
				end
			end
			GuardiaoBrindes_Config.TextArea.timer = GuardiaoBrindes_Config.TextArea.timer + 1
		else
			GuardiaoBrindes_Config.TextArea.timer = 0
			GuardiaoBrindes_Config.TextArea.selected = false
			RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 296, GuardiaoBrindes_Config.Codigo, 90, 8)
		end

		SetTextBg(0, 0, 0, 0)
		SetFontType(1)
		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 338, GuardiaoBrindes_Config.Texts[GetLanguage()][8], 80, 8)
		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 376, GuardiaoBrindes_Config.Texts[GetLanguage()][9], 80, 8)
	...
	if GuardiaoBrindes_Config.Page == 1 then
		...
		glColor4f(0.04, 0.04, 0.04, 0.5)
		DrawBar(278+offset-GuardiaoBrindes_Config.WindowOffset, 50, 155, 84)
		DrawBar(278+offset-GuardiaoBrindes_Config.WindowOffset, 50, 155, 25)
		DrawBar(278+offset-GuardiaoBrindes_Config.WindowOffset, 180, 155, 230)
		DrawBar(278+offset-GuardiaoBrindes_Config.WindowOffset, 180, 155, 20)
		glColor4f(0.8, 0.8, 0.8, 0.1)
		local line = 229
		local c = 1
		while c < #GuardiaoBrindes_Config.ShortLista.Codigo do
			DrawBar(290+offset-GuardiaoBrindes_Config.WindowOffset, line, 110, 1)
			line = line+25
			c = c+1
		end
		c = nil
		
		glColor4f(0.64, 0.64, 0.64, 0.5)		
		DrawBar(278+offset-GuardiaoBrindes_Config.WindowOffset, 50, 0.7, 84)
		DrawBar(433+offset-GuardiaoBrindes_Config.WindowOffset, 50, 0.7, 84)
		DrawBar(278+offset-GuardiaoBrindes_Config.WindowOffset, 50, 155, 0.7)
		DrawBar(278+offset-GuardiaoBrindes_Config.WindowOffset, 133, 155, 0.7)
		DrawBar(278+offset-GuardiaoBrindes_Config.WindowOffset, 75, 155, 0.7)
		
		EndDrawBar()
		EnableAlphaTest(1)


		GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.acessar, 310+offset-GuardiaoBrindes_Config.WindowOffset, 146, 90, 24)
		local state = 0
		...
		DrawButton.Large(state, 310+offset-GuardiaoBrindes_Config.WindowOffset, 146, 90, 24)
		...
		if GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.ListID ~= nil then
			...
			SetTextColor(150, 150, 150, 200)
		end

		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 154, GuardiaoBrindes_Config.Texts[GetLanguage()][12], 150, 8)
		SetFontType(0)

		if GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.ListID ~= nil then
			-- NOME DO CÓDIGO
			GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.copiar, 280+offset-GuardiaoBrindes_Config.WindowOffset, 77, 124, 25)
			SetTextColor(255, 85, 0, 255)
			RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 60, GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.Nome, 150, 8)
		
			-- Verifica se o mouse está sobre o botão
			if MousePosX() >= 280+offset-GuardiaoBrindes_Config.WindowOffset and MousePosX() <= 280+offset-GuardiaoBrindes_Config.WindowOffset + 124 and MousePosY() >= 77 and MousePosY() <= 77+25 then
				SetBlend(1)
				
				-- Verifica se o botão foi clicado
				if GuardiaoBrindes.ButtonClicked(GuardiaoBrindes_Config.ButtonID.copiar) then
					-- Efeito verde quando clicado
					glColor4f(0.0, 0.8, 0.0, 0.5) -- Verde com transparência
				else
					-- Efeito cinza padrão quando apenas hover
					glColor4f(0.2, 0.2, 0.2, 0.6)
				end
				
				DrawBar(280+offset-GuardiaoBrindes_Config.WindowOffset, 77, 124, 25)
				EndDrawBar()
			end

			--C?IGO
			SetTextColor(255, 208, 0, 180)
			if GuardiaoBrindes_Config.CopiadoTimer > 0 then
				RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 79, GuardiaoBrindes_Config.Texts[GetLanguage()][26], 150, 8)
				GuardiaoBrindes_Config.CopiadoTimer = GuardiaoBrindes_Config.CopiadoTimer - 1
			else
				if GuardiaoBrindes.ButtonMouseOver(GuardiaoBrindes_Config.ButtonID.copiar, MousePosX(), MousePosY()) then
					RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 79, GuardiaoBrindes_Config.Texts[GetLanguage()][25], 150, 8)
				else
					RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 79, GuardiaoBrindes_Config.Texts[GetLanguage()][13], 150, 8)
				end
			end	
			RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 109, GuardiaoBrindes_Config.Texts[GetLanguage()][14], 150, 8)
			SetTextColor(255, 255, 255, 255)

			GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.hidden, 406+offset-GuardiaoBrindes_Config.WindowOffset, 77, 25, 24)
			local stateHidden = 0
			if GuardiaoBrindes.ButtonMouseOver(GuardiaoBrindes_Config.ButtonID.hidden, MousePosX(), MousePosY()) then
				if CheckRepeatKey(Keys.LButton) == 1 then
					stateHidden = 2
				else
					stateHidden = 1
			...
			if GuardiaoBrindes_Config.HiddenCode then
				if MousePosX() >= 280+offset-GuardiaoBrindes_Config.WindowOffset and MousePosX() <= 280+offset-GuardiaoBrindes_Config.WindowOffset + 124+2+25 and MousePosY() >= 77 and MousePosY() <= 77+25 then
					DrawButton.Unhidden(stateHidden, 406+offset-GuardiaoBrindes_Config.WindowOffset, 77, 25, 24)
				end
				RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 89, GuardiaoBrindes_Config.Texts[GetLanguage()][27], 150, 8)
			else
				if MousePosX() >= 280+offset-GuardiaoBrindes_Config.WindowOffset and MousePosX() <= 280+offset-GuardiaoBrindes_Config.WindowOffset + 124+2+25 and MousePosY() >= 77 and MousePosY() <= 77+25 then
					DrawButton.Hidden(stateHidden, 406+offset-GuardiaoBrindes_Config.WindowOffset, 77, 25, 24)
				end
				RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 89, GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.Codigo, 150, 8)
			end

			--VALIDADE DO C?IGO
			if GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.TemValidade == 1 then
				RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 119, GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.Data, 150, 8)
			else
				RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 119, "-", 30 , 8)
			end
		end

		SetTextColor(255, 85, 0, 255)
		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 188, GuardiaoBrindes_Config.Texts[GetLanguage()][11], 150, 8)
		SetTextColor(255, 255, 255, 255)
		local line = 212
		for i in ipairs(GuardiaoBrindes_Config.ShortLista.Codigo) do
			RenderImage2(40065, 290+offset-GuardiaoBrindes_Config.WindowOffset, line+2, 5, 5, 0, 0, 0.591827401425252121, 0.591827401425252121, 1, 1, 1.0)
			RenderText3(300+offset-GuardiaoBrindes_Config.WindowOffset, line, string.format("%s", GuardiaoBrindes_Config.ShortLista.Codigo[i].Nome), 150, ALIGN_LEFT)
			line = line+25
		end
		DisableAlphaBlend()
	end
	...
	if GuardiaoBrindes_Config.Page == 2 then
		...
		glColor4f(0.0, 0.0, 0.0, 0.6)
		DrawBar(278+offset-GuardiaoBrindes_Config.WindowOffset, 50, 155, 114)
		DrawBar(278+offset-GuardiaoBrindes_Config.WindowOffset, 210, 155, 202)
		DrawBar(278+offset-GuardiaoBrindes_Config.WindowOffset, 210, 155, 20)
		glColor4f(0.8, 0.8, 0.8, 0.1)
		...
		GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.acessar, 310+offset-GuardiaoBrindes_Config.WindowOffset, 175, 90, 24)
		local state = 0
		...
		DrawButton.Large(state, 310+offset-GuardiaoBrindes_Config.WindowOffset, 175, 90, 24)

		DisableAlphaBlend()

		-- EFEITO HOVER E SELEÇÃO PARA ITENS
		local line = 234
		for i in ipairs(GuardiaoBrindes_Config.ShortLista.Item) do
			-- Verifica se é o item selecionado
			if GuardiaoBrindes_Config.ShortListaConfig.Item.Selected and 
				GuardiaoBrindes_Config.ShortListaConfig.Item.Selected.ListID == GuardiaoBrindes_Config.ShortLista.Item[i].ListID then
				-- Desenha fundo verde para item selecionado
				SetBlend(1)
				glColor4f(0.0, 0.5, 0.0, 0.3) -- Verde com transparência
				DrawBar(290+offset-GuardiaoBrindes_Config.WindowOffset, line+2, 110, 22)
				EndDrawBar()
			-- Verifica hover apenas se não for o item selecionado
			elseif MousePosX() >= 290+offset-GuardiaoBrindes_Config.WindowOffset and 
					MousePosX() <= 400-GuardiaoBrindes_Config.WindowOffset and
					MousePosY() >= line+1 and MousePosY() <= line+24 then
				-- Desenha fundo cinza claro para hover
				SetBlend(1)
		...
		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 183, GuardiaoBrindes_Config.Texts[GetLanguage()][15], 150, 8)
		SetFontType(0)

		SetTextColor(255, 85, 0, 255)
		RenderText3(355+offset-GuardiaoBrindes_Config.WindowOffset, 217, GuardiaoBrindes_Config.Texts[GetLanguage()][16], 150, 8)
		SetTextColor(255, 255, 255, 255)
		line = 244
		for i in ipairs(GuardiaoBrindes_Config.ShortLista.Item) do
			RenderImage2(40065, 290+offset-GuardiaoBrindes_Config.WindowOffset, line+2, 5, 5, 0, 0, 0.591827401425252121, 0.591827401425252121, 1, 1, 1.0)
			RenderText3(300+offset-GuardiaoBrindes_Config.WindowOffset, line, string.format("%s", GuardiaoBrindes_Config.ShortLista.Item[i].Nome), 150, ALIGN_LEFT)
			line = line+25
		end
		DisableAlphaBlend()
	end
		...
		if GuardiaoBrindes_Config.TextArea.onFocus then
			if CheckWindowOpen(UIChatWindow) ~= 1 then
				if GuardiaoBrindes_Config.Alfabeto[key] ~= nil then
					if key == Keys.V then
						if CheckRepeatKey(Keys.ControlKey) == 1 then return true end
					end
...
function GuardiaoBrindes.ClickEvent()
			...
			if GuardiaoBrindes_Config.TextArea.onFocus then
				if GuardiaoBrindes_Config.TextArea.selected then
					...
					if string.len(GuardiaoBrindes_Config.Codigo) > 0 then
						GuardiaoBrindes_Config.TextArea.selected = true
					end
				end
			else
	...
	if GuardiaoBrindes_Config.Page == 1 then
		...
		if GuardiaoBrindes.ButtonMouseOver(GuardiaoBrindes_Config.ButtonID.copiar, MousePosX(), MousePosY()) then
			SetClipboard(GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.Codigo)
			GuardiaoBrindes_Config.CopiadoTimer = 20
			return true
		end
		...
		if GuardiaoBrindes.ButtonMouseOver(GuardiaoBrindes_Config.ButtonID.hidden, x, y) then
			if GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.ListID ~= nil then
				GuardiaoBrindes_Config.Button[GuardiaoBrindes_Config.ButtonID.hidden].clicked = true
				if GuardiaoBrindes_Config.HiddenCode then
					GuardiaoBrindes_Config.HiddenCode = false
				else
					GuardiaoBrindes_Config.HiddenCode = true
				end
			end
		...
		if x >= 290+offset-GuardiaoBrindes_Config.WindowOffset and x <= 400+offset-GuardiaoBrindes_Config.WindowOffset then
			local line = 204
			for i in ipairs(GuardiaoBrindes_Config.ShortLista.Codigo) do
...
function GuardiaoBrindes.ScrollMouse(Direction)
	...
	if GuardiaoBrindes.CheckOpen() then
		if GuardiaoBrindes_Config.AlertWindow.Show then return 1 end

		if GuardiaoBrindes_Config.Page == 1 then
			local area = {x1 = 285+offset, x2 = 425+offset, y1 = 205, y2 = 415}
		...
		if GuardiaoBrindes_Config.Page == 2 then
			local area = {x1 = 285+offset, x2 = 425+offset, y1 = 230, y2 = 415}
			if x >= area.x1-GuardiaoBrindes_Config.WindowOffset and x <= area.x2-GuardiaoBrindes_Config.WindowOffset and y >= area.y1 and y <= area.y2 then
				if Direction > 0 then
...
function GuardiaoBrindes.UpdateKey()
	...
	if GuardiaoBrindes_Config.TextArea.onFocus then
		if CheckWindowOpen(UIChatWindow) ~= 1 then
			...
			if CheckPressedKey(Keys.V) == 1 then
				if CheckRepeatKey(Keys.ControlKey) == 1 then
					local clip = GetClipboard()
					clip = clip:gsub("[^%-A-z0-9]", "")
					clip = string.sub(clip, 1, 16)
					if clip:len() == 16 then
						GuardiaoBrindes_Config.Codigo = clip
					end
					return
				end
			end
