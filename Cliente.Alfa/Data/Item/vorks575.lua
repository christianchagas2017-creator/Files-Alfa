...
--#region FUNÇÕES BARRA DE ROLAGEM CODIGOS
...
function GuardiaoBrindes.AfterInterface()
	...
	if	CheckWindowOpen(UIExpandInventory)	== 1	then	GuardiaoBrindes_Config.WindowOffset = 190 else GuardiaoBrindes_Config.WindowOffset = 0	end
	if	CheckWindowOpen(UIExpandWarehouse)	== 1	then	GuardiaoBrindes.Close()	end
	if	CheckWindowOpen(UIMuHelper)			== 1	then	GuardiaoBrindes.Close()	end
	--#endregion
	...
	if GuardiaoBrindes_Config.Page == 0 or GuardiaoBrindes_Config.Page == 1 then
		if GuardiaoBrindes_Config.AlertWindow.Show then
			if GuardiaoBrindes_Config.AlertWindow.Type == 0 then
				RenderImage2(31137, 210, 70, 220, 90, 0, 0, 0.83, 1, 1, 1, 1.0)
				GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.ok, 278, 120, 40, 20)			
				...
				RenderText3(302, 90, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][20]), 200, 8)
				RenderText3(302, 100, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][21]), 200, 8)
			end
			...
			if GuardiaoBrindes_Config.AlertWindow.Type == 1 then
				...
				SetTextBg(0, 0, 0, 0)				
				SetTextColor(255, 255, 255, 255)
				RenderText3(302, 100, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][23]), 200, 8)
			end
		end
	end
	--#endregion
		...
		if GuardiaoBrindes_Config.AlertWindow.Show then
			if GuardiaoBrindes_Config.AlertWindow.Type >= 0 then
				...
				if 	GuardiaoBrindes_Config.AlertWindow.Type < 2 then
					RenderText3(302, 100, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][17]), 200, 8)
				end

				if GuardiaoBrindes_Config.AlertWindow.Type == 2 then
					RenderText3(302, 100, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][18]), 200, 8)
				end

				if GuardiaoBrindes_Config.AlertWindow.Type == 3 then
					RenderText3(302, 100, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][24]), 200, 8)
				end
			end
		end
		DisableAlphaBlend()
...
function GuardiaoBrindes.Interface()						
	...
	--#region BASE JANELA
	EnableAlphaTest()
	RenderImage(31322, 260-GuardiaoBrindes_Config.WindowOffset, 0, 190, 428)
	RenderImage(31353, 260-GuardiaoBrindes_Config.WindowOffset, 0, 190, 64)
	RenderImage(31355, 260-GuardiaoBrindes_Config.WindowOffset, 64, 21, 320)
	RenderImage(31356, 429-GuardiaoBrindes_Config.WindowOffset, 64, 21, 320)
	RenderImage(31357, 260-GuardiaoBrindes_Config.WindowOffset, 384, 190, 45)
	
	SetFontType(1)
	SetTextBg(0, 0, 0, 255)
	SetTextColor(255, 255, 255, 240)
	RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 12, string.format(GuardiaoBrindes_Config.Texts[GetLanguage()][1]), 80, 8)
	
	GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.fechar,470, 395, 24, 24)
	...
	if GuardiaoBrindes_Config.Page == 0 then		
		...
		DrawBar(276-GuardiaoBrindes_Config.WindowOffset, 50, 159, 358)
		EndDrawBar()
		
		EnableAlphaTest(1)		
				
		RenderImage2(GuardiaoBrindes_Config.Images.GB_Chest, 273-GuardiaoBrindes_Config.WindowOffset, 60, 154, 135, 0, 0, 0.92982659, 0.8181264, 1,1, 1.0)
	
		RenderImage(31340, 274-GuardiaoBrindes_Config.WindowOffset, 50, 14, 14) -- topo esquerdo
		RenderImage(31341, 425-GuardiaoBrindes_Config.WindowOffset, 50, 14, 14) -- topo direito
		RenderImage(31342, 274-GuardiaoBrindes_Config.WindowOffset, 400, 14, 14) -- base esquerdo
		RenderImage(31343, 425-GuardiaoBrindes_Config.WindowOffset, 400, 14, 14) -- base direito

		for i = 1, 137 do
			RenderImage(31344, 287-GuardiaoBrindes_Config.WindowOffset+i, 50, 1, 14) -- horizontal superior
			RenderImage(31345, 287-GuardiaoBrindes_Config.WindowOffset+i, 400, 1, 14) -- horizontal superior
		end

		for i = 1, 340 do
			RenderImage(31346, 274-GuardiaoBrindes_Config.WindowOffset, 63+i, 14, 1) -- vertical esquerda
			RenderImage(31347, 425-GuardiaoBrindes_Config.WindowOffset, 63+i, 14, 1) -- vertical direita
		end	
		
		GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.acessar, 310-GuardiaoBrindes_Config.WindowOffset, 330, 90, 25)
		RenderImage2(31326, 310-GuardiaoBrindes_Config.WindowOffset, 330, 110, 25,0, 0, 1.0, 0.2245212, 1, 1, 1.0)
		GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.meuscodigos, 310-GuardiaoBrindes_Config.WindowOffset, 368, 90, 25)
		RenderImage2(31326, 310-GuardiaoBrindes_Config.WindowOffset, 368, 110, 25,0, 0, 1.0, 0.2245212, 1, 1, 1.0)
		GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.textarea, 300-GuardiaoBrindes_Config.WindowOffset, 290, 110, 20)
		RenderImage2(31138, 300-GuardiaoBrindes_Config.WindowOffset, 290, 110, 20,0, 0, 0.6682579, 0.714924204, 1, 1, 1.0)
		...
		if not GuardiaoBrindes.ButtonClicked(GuardiaoBrindes_Config.ButtonID.acessar) then
			if GuardiaoBrindes.ButtonMouseOver(GuardiaoBrindes_Config.ButtonID.acessar, MousePosX(), MousePosY()) then
				RenderImage2(31326, 310-GuardiaoBrindes_Config.WindowOffset, 330, 110, 25,0, 0.2264566, 1.0, 0.2245212, 1, 1, 1.0)
			end
		end
		...
		if not GuardiaoBrindes.ButtonClicked(GuardiaoBrindes_Config.ButtonID.meuscodigos) then
			if GuardiaoBrindes.ButtonMouseOver(GuardiaoBrindes_Config.ButtonID.meuscodigos, MousePosX(), MousePosY()) then
				RenderImage2(31326, 310-GuardiaoBrindes_Config.WindowOffset, 368, 110, 25,0, 0.2264566, 1.0, 0.2245212, 1, 1, 1.0)
			end
		end
		...
		RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 190, GuardiaoBrindes_Config.Texts[GetLanguage()][2], 150, 8)
		
		SetFontType(1)			
		SetTextBg(0, 0, 0, 0)			
		SetTextColor(255, 255, 255, 255)
		RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 220, GuardiaoBrindes_Config.Texts[GetLanguage()][3], 150, 8)
		RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 230, GuardiaoBrindes_Config.Texts[GetLanguage()][4], 150, 8)
		RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 240, GuardiaoBrindes_Config.Texts[GetLanguage()][5], 150, 8)
		
		RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 260, GuardiaoBrindes_Config.Texts[GetLanguage()][6], 150, 8)
		RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 270, GuardiaoBrindes_Config.Texts[GetLanguage()][7], 150, 8)
		...
		if GuardiaoBrindes_Config.TextArea.onFocus then
			if GuardiaoBrindes_Config.TextArea.timer >= 8 then
				...
				RenderText3(312-GuardiaoBrindes_Config.WindowOffset, 296, GuardiaoBrindes_Config.Codigo, 90, 1)
			else
				RenderText3(312-GuardiaoBrindes_Config.WindowOffset, 296, GuardiaoBrindes_Config.Codigo..GuardiaoBrindes_Config.TextArea.cursor,90, 1)
			end
		...
		RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 337, GuardiaoBrindes_Config.Texts[GetLanguage()][8], 80, 8)
		RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 375, GuardiaoBrindes_Config.Texts[GetLanguage()][9], 80, 8)		
	...
	if GuardiaoBrindes_Config.Page == 1 then
		SetBlend()
		glColor4f(0.0, 0.0, 0.0, 0.6)
		DrawBar(278-GuardiaoBrindes_Config.WindowOffset, 50, 155, 84)
		DrawBar(278-GuardiaoBrindes_Config.WindowOffset, 50, 155, 25)
		DrawBar(278-GuardiaoBrindes_Config.WindowOffset, 180, 155, 230)
		DrawBar(278-GuardiaoBrindes_Config.WindowOffset, 180, 155, 20)
		glColor4f(0.8, 0.8, 0.8, 0.1)
		local line = 229
		local c = 1
		while c < #GuardiaoBrindes_Config.ShortLista.Codigo do
			DrawBar(290-GuardiaoBrindes_Config.WindowOffset, line, 110, 1)
			line = line+25
			c = c+1
		end
		c = nil
		...
		RenderImage(31342, 274-GuardiaoBrindes_Config.WindowOffset, 400, 14, 14) -- base esquerdo
		RenderImage(31343, 425-GuardiaoBrindes_Config.WindowOffset, 400, 14, 14) -- base direito
		RenderImage(31340, 274-GuardiaoBrindes_Config.WindowOffset, 179, 14, 14) -- topo esquerdo
		RenderImage(31341, 425-GuardiaoBrindes_Config.WindowOffset, 179, 14, 14) -- topo direito
		RenderImage(31342, 274-GuardiaoBrindes_Config.WindowOffset, 124, 14, 14) -- base esquerdo
		RenderImage(31343, 425-GuardiaoBrindes_Config.WindowOffset, 124, 14, 14) -- base direito
		for i = 1, 137 do
			RenderImage(31344, 287-GuardiaoBrindes_Config.WindowOffset+i, 50, 1, 14) -- horizontal superior
			RenderImage(31344, 287-GuardiaoBrindes_Config.WindowOffset+i, 179, 1, 14) -- horizontal superior
			
			RenderImage(31345, 287-GuardiaoBrindes_Config.WindowOffset+i, 124, 1, 14) -- horizontal superior
			RenderImage(31345, 287-GuardiaoBrindes_Config.WindowOffset+i, 400, 1, 14) -- horizontal superior
		end
		for i = 1, 60 do
			RenderImage(31346, 274-GuardiaoBrindes_Config.WindowOffset, 63+i, 14, 1) -- vertical esquerda
		...
		for i = 1, 207 do
			RenderImage(31346, 274-GuardiaoBrindes_Config.WindowOffset, 192+i, 14, 1) -- vertical esquerda
			RenderImage(31347, 425-GuardiaoBrindes_Config.WindowOffset, 192+i, 14, 1) -- vertical direita
		end
		--#endregion

		
		RenderImage(31270, 413-GuardiaoBrindes_Config.WindowOffset,228, 7, 3) -- topo	
		for i = 230, 350, 15 do
			RenderImage(31271, 413-GuardiaoBrindes_Config.WindowOffset, i, 7, 15) -- meio
		end
		RenderImage(31272, 413-GuardiaoBrindes_Config.WindowOffset, 365, 7, 3) -- baixo
		...
		RenderImage(31273, 409-GuardiaoBrindes_Config.WindowOffset, cursorPos, 15, 30)

		GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.acessar, 310-GuardiaoBrindes_Config.WindowOffset, 146, 90, 24)

		if GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.ListID ~= nil then
			if not GuardiaoBrindes.ButtonClicked(GuardiaoBrindes_Config.ButtonID.acessar) then			
				if GuardiaoBrindes.ButtonMouseOver(GuardiaoBrindes_Config.ButtonID.acessar, MousePosX(), MousePosY()) then
					RenderImage2(31326, 310-GuardiaoBrindes_Config.WindowOffset, 146, 110, 25,0, 0.2264566, 1.0, 0.2245212, 1, 1, 1.0)
				else
					RenderImage2(31326, 310-GuardiaoBrindes_Config.WindowOffset, 146, 110, 25,0, 0, 1.0, 0.2245212, 1, 1, 1.0)
				end
			else
				RenderImage2(31326, 310-GuardiaoBrindes_Config.WindowOffset, 146, 110, 25,0, 0, 1.0, 0.2245212, 1, 1, 1.0)
			end
		else
			RenderImage2(31326, 310-GuardiaoBrindes_Config.WindowOffset, 146, 110, 25,0, 0.4509778, 1.0, 0.2245212, 1, 1, 1.0)
		end
		
		DisableAlphaBlend()
 
		if MousePosX() >= 290-GuardiaoBrindes_Config.WindowOffset and MousePosX() <= 400-GuardiaoBrindes_Config.WindowOffset then
			local line = 204
			for i in ipairs(GuardiaoBrindes_Config.ShortLista.Codigo) do
				if MousePosY() >= line+1 and MousePosY() <= line+24 then
					SetBlend()
					glColor4f(1.0, 1.0, 1.0, 0.1)
					DrawBar(290-GuardiaoBrindes_Config.WindowOffset, line+2, 110, 22)
					EndDrawBar()
				end
				line = line+25
			end
		...
		RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 153, GuardiaoBrindes_Config.Texts[GetLanguage()][12], 150, 8)

		if GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.ListID ~= nil then
			SetTextColor(255, 85, 0, 255)
			RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 60, GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.Nome, 150, 8)
			SetTextColor(255, 208, 0, 180)
			RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 79, GuardiaoBrindes_Config.Texts[GetLanguage()][13], 150, 8)
			RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 109, GuardiaoBrindes_Config.Texts[GetLanguage()][14], 150, 8)
			SetTextColor(255, 255, 255, 255)
			RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 89, GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.Codigo, 150, 8)
			if GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.TemValidade == 1 then
				RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 119, GuardiaoBrindes_Config.ShortListaConfig.Codigo.Selected.Data, 150, 8)
			else
				RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 119, "-", 30 , 8)
			end
		end
		SetTextColor(255, 85, 0, 255)
		RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 188, GuardiaoBrindes_Config.Texts[GetLanguage()][11], 150, 8)
		SetTextColor(255, 255, 255, 255)
		local line = 212
		for i in ipairs(GuardiaoBrindes_Config.ShortLista.Codigo) do
			RenderImage2(GuardiaoBrindes_Config.Images.GB_Ponto, 290-GuardiaoBrindes_Config.WindowOffset, line+2, 5, 5, 0, 0, 0.591827401425252121, 0.591827401425252121, 1, 1, 1.0)
			RenderText3(300-GuardiaoBrindes_Config.WindowOffset, line, string.format("%s", GuardiaoBrindes_Config.ShortLista.Codigo[i].Nome), 150, ALIGN_LEFT)
			line = line+25
		end 
	...
	if GuardiaoBrindes_Config.Page == 2 then
		SetBlend()
		glColor4f(0.0, 0.0, 0.0, 0.6)
		DrawBar(278-GuardiaoBrindes_Config.WindowOffset, 50, 155, 114)
		DrawBar(278-GuardiaoBrindes_Config.WindowOffset, 210, 155, 202)
		DrawBar(278-GuardiaoBrindes_Config.WindowOffset, 210, 155, 20)
		glColor4f(0.8, 0.8, 0.8, 0.1)
		...
		RenderImage(31340, 274-GuardiaoBrindes_Config.WindowOffset, 50, 14, 14) -- topo esquerdo
		RenderImage(31341, 425-GuardiaoBrindes_Config.WindowOffset, 50, 14, 14) -- topo direito
		RenderImage(31342, 274-GuardiaoBrindes_Config.WindowOffset, 154, 14, 14) -- base esquerdo
		RenderImage(31343, 425-GuardiaoBrindes_Config.WindowOffset, 154, 14, 14) -- base direito
		
		
		RenderImage(31340, 274-GuardiaoBrindes_Config.WindowOffset, 210, 14, 14) -- topo esquerdo
		RenderImage(31341, 425-GuardiaoBrindes_Config.WindowOffset, 210, 14, 14) -- topo direito
		RenderImage(31342, 274-GuardiaoBrindes_Config.WindowOffset, 400, 14, 14) -- base esquerdo
		RenderImage(31343, 425-GuardiaoBrindes_Config.WindowOffset, 400, 14, 14) -- base direito

		for i = 1, 137 do
			RenderImage(31344, 287-GuardiaoBrindes_Config.WindowOffset+i, 50, 1, 14) -- horizontal superior
			RenderImage(31344, 287-GuardiaoBrindes_Config.WindowOffset+i, 210, 1, 14) -- horizontal superior
			
			RenderImage(31345, 287-GuardiaoBrindes_Config.WindowOffset+i, 154, 1, 14) -- horizontal superior
			RenderImage(31345, 287-GuardiaoBrindes_Config.WindowOffset+i, 400, 1, 14) -- horizontal superior
		end
		...
		for i = 1, 180 do
			RenderImage(31346, 274-GuardiaoBrindes_Config.WindowOffset, 223+i, 14, 1) -- vertical esquerda
			RenderImage(31347, 425-GuardiaoBrindes_Config.WindowOffset, 223+i, 14, 1) -- vertical direita
		end

		RenderImage(31270, 413-GuardiaoBrindes_Config.WindowOffset,242, 7, 3) -- topo	
		for i = 245, 365, 15 do
			RenderImage(31271, 413-GuardiaoBrindes_Config.WindowOffset, i, 7, 15) -- meio
		end
		RenderImage(31272, 413-GuardiaoBrindes_Config.WindowOffset, 380, 7, 3) -- baixo
		...
		GuardiaoBrindes.CreateButton(GuardiaoBrindes_Config.ButtonID.acessar, 310-GuardiaoBrindes_Config.WindowOffset, 175, 90, 24)

		if GuardiaoBrindes_Config.ShortListaConfig.Item.Selected.ListID ~= nil then
			if not GuardiaoBrindes.ButtonClicked(GuardiaoBrindes_Config.ButtonID.acessar) then			
				if GuardiaoBrindes.ButtonMouseOver(GuardiaoBrindes_Config.ButtonID.acessar, MousePosX(), MousePosY()) then
					RenderImage2(31326, 310-GuardiaoBrindes_Config.WindowOffset, 175, 110, 25,0, 0.2264566, 1.0, 0.2245212, 1, 1, 1.0)
				else
					RenderImage2(31326, 310-GuardiaoBrindes_Config.WindowOffset, 175, 110, 25,0, 0, 1.0, 0.2245212, 1, 1, 1.0)
				end
			else
				RenderImage2(31326, 310-GuardiaoBrindes_Config.WindowOffset, 175, 110, 25,0, 0, 1.0, 0.2245212, 1, 1, 1.0)
			end
		else
			RenderImage2(31326, 310-GuardiaoBrindes_Config.WindowOffset, 175, 110, 25,0, 0.4509778, 1.0, 0.2245212, 1, 1, 1.0)
		end
		...
		RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 182, GuardiaoBrindes_Config.Texts[GetLanguage()][15], 150, 8)

		SetTextColor(255, 85, 0, 255)
		RenderText3(355-GuardiaoBrindes_Config.WindowOffset, 217, GuardiaoBrindes_Config.Texts[GetLanguage()][16], 150, 8)
		SetTextColor(255, 255, 255, 255)
		local line = 244
		for i in ipairs(GuardiaoBrindes_Config.ShortLista.Item) do
			RenderImage2(GuardiaoBrindes_Config.Images.GB_Ponto, 290-GuardiaoBrindes_Config.WindowOffset, line+2, 5, 5, 0, 0, 0.591827401425252121, 0.591827401425252121, 1, 1, 1.0)
			RenderText3(300-GuardiaoBrindes_Config.WindowOffset, line, string.format("%s", GuardiaoBrindes_Config.ShortLista.Item[i].Nome), 150, ALIGN_LEFT)
			line = line+25
		end 
...
function GuardiaoBrindes.ClickEvent()
	...
	if GuardiaoBrindes_Config.Page == 1 then
		...
		if x >= 290-GuardiaoBrindes_Config.WindowOffset and x <= 400-GuardiaoBrindes_Config.WindowOffset then
			local line = 204
			for i in ipairs(GuardiaoBrindes_Config.ShortLista.Codigo) do
...
function GuardiaoBrindes.ScrollMouse(Direction)
	...
	if GuardiaoBrindes.CheckOpen() then
		...
		if GuardiaoBrindes_Config.Page == 1 then
			local area = {x1 = 285, x2 = 425, y1 = 205, y2 = 415}
		...
		if GuardiaoBrindes_Config.Page == 2 then
			local area = {x1 = 285, x2 = 425, y1 = 230, y2 = 415}
			if x >= area.x1-GuardiaoBrindes_Config.WindowOffset and x <= area.x2-GuardiaoBrindes_Config.WindowOffset and y >= area.y1 and y <= area.y2 then
				if Direction > 0 then
