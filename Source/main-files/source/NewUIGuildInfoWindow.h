...
#if CLIENT_VERSION >= 1001
			IMAGE_GUILDINFO_BACK_VOID = BITMAP_NEW_DEFAULT_WINDOW_BACK, //"newui_repair_00.tga"
			IMAGE_GUILDINFO_FRAME_BOX,
			IMAGE_GUILDINFO_FRAME_BOX_LARGE,
			IMAGE_GUILDINFO_FRAME_BOX_BIG = BITMAP_NEW_STORE_NAME_BIG,
			IMAGE_GUILDINFO_FRAME_BOX_BIG_2,
			IMAGE_GUILDINFO_ROLE_GM,
			IMAGE_GUILDINFO_ROLE_AM,
			IMAGE_GUILDINFO_ROLE_BM,
			IMAGE_GUILDINFO_NEW_SCROLL_BACK,
			IMAGE_GUILDINFO_NEW_SCROLL_MIDDLE,
#endif
		};
