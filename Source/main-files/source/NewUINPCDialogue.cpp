...
#elif CLIENT_VERSION >= 1001
	//RenderBitmap(IMAGE_ND_BACK_VOID, m_Pos.x, m_Pos.y, ND_WIDTH, ND_HEIGHT, 0.0, 0.0, 0.83, 0.935, 1, 1, 0.0);
	RenderImageScaleAuto(IMAGE_ND_BACK_VOID, m_Pos.x, m_Pos.y, ND_WIDTH, ND_HEIGHT);
	RenderImageScaleAuto(IMAGE_ND_LINE, m_Pos.x + 7.1f, m_Pos.y + 181, 176.f, 10.f);
#endif
}
...
void CNewUINPCDialogue::RenderContributePoint()
{
		...
		|| (544 == g_QuestMng.GetNPCIndex() && 2 == Hero->m_byGensInfluence))
	{
		...
		::sprintf(szContribute, GlobalText[2986], m_dwContributePoint);
		g_pRenderText->SetTextColor(255, 230, 210, 255);
		g_pRenderText->RenderText(m_Pos.x, m_Pos.y + 42, szContribute, ND_WIDTH, 0, RT3_SORT_CENTER);
#endif
...
#elif CLIENT_VERSION >= 1001
	LoadBitmap("Interface\\btn_exit.jpg", IMAGE_ND_BTN_CLOSE, GL_LINEAR, GL_REPEAT);
	LoadBitmap("Interface\\newui_msgbox_back.jpg", IMAGE_ND_BACK, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back04.tga", IMAGE_ND_TOP, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back02-L.tga", IMAGE_ND_LEFT, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back02-R.tga", IMAGE_ND_RIGHT, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back03.tga", IMAGE_ND_BOTTOM, GL_LINEAR);
	LoadBitmap("Interface\\default_window_back.jpg", IMAGE_ND_BACK_VOID, GL_LINEAR);
	LoadBitmap("Interface\\division_bar.tga", IMAGE_ND_LINE, GL_LINEAR);
	LoadBitmap("Interface\\btn_previous.jpg", IMAGE_ND_BTN_L, GL_LINEAR);
	LoadBitmap("Interface\\btn_next.jpg", IMAGE_ND_BTN_R, GL_LINEAR);
	LoadBitmap("Interface\\Gens_point.tga", IMAGE_ND_CONTRIBUTE_BG, GL_LINEAR);
#endif
...
void CNewUINPCDialogue::UnloadImages()
{
	...
	DeleteBitmap(IMAGE_ND_BACK_VOID);
#endif
