...
#elif CLIENT_VERSION >= 1001
	m_Button = new CCustomButtons[GUILDMAKEBUTTON_COUNT];
#endif
...
void CNewUIGuildMakeWindow::LoadImages()
{
...
#elif CLIENT_VERSION >= 1001
	LoadBitmap("Interface\\btn_exit.jpg", IMAGE_GUILDMAKE_BTN_EXIT, GL_LINEAR, GL_REPEAT);
	LoadBitmap("Interface\\newui_msgbox_back.jpg", IMAGE_GUILDMAKE_BACK, GL_LINEAR);
	LoadBitmap("Interface\\btn_large.jpg", IMAGE_GUILDMAKE_MAKEBUTTON, GL_LINEAR);
	LoadBitmap("Interface\\btn_medium.jpg", IMAGE_GUILDMAKE_NEXTBUTTON, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back01.tga", IMAGE_GUILDMAKE_BACK_TOP, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back02-L.tga", IMAGE_GUILDMAKE_BACK_LEFT, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back02-R.tga", IMAGE_GUILDMAKE_BACK_RIGHT, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back03.tga", IMAGE_GUILDMAKE_BACK_BOTTOM, GL_LINEAR);
	...
	LoadBitmap("Interface\\default_window_back.jpg", IMAGE_GUILDMAKE_BACK_VOID, GL_LINEAR);
	LoadBitmap("Interface\\store_name.jpg", IMAGE_GUILDMAKE_FRAME_BOX, GL_LINEAR);
	LoadBitmap("Interface\\store_name_big.jpg", IMAGE_GUILDMAKE_FRAME_BOX_BIG, GL_LINEAR);
...
#if CLIENT_VERSION >= 1001
	DeleteBitmap(IMAGE_GUILDMAKE_BACK_VOID);
	DeleteBitmap(IMAGE_GUILDMAKE_FRAME_BOX);
	DeleteBitmap(IMAGE_GUILDMAKE_FRAME_BOX_BIG);
#endif
}
...
#elif CLIENT_VERSION >= 1001
	m_Button[GUILDMAKEBUTTON_INFO_MAKE].SetPos(m_Pos.x + ((190 / 2) - (108 / 2)), m_Pos.y + 75);
	m_Button[GUILDMAKEBUTTON_INFO_MAKE].ChangeTextColor(RGBA(245, 232, 202, 255));
	m_Button[GUILDMAKEBUTTON_INFO_MAKE].SetFont(g_hFontBold);
...
void CNewUIGuildMakeWindow::RenderGMInfo()
{
	...
	g_pRenderText->RenderText(m_Pos.x, m_Pos.y + 50, Text, 190, 0, RT3_SORT_CENTER);
	g_pRenderText->SetFont(g_hFont);
...
void CNewUIGuildMakeWindow::RenderGMMark()
{
	...
	RenderGoldRect(m_Pos.x + 30, m_Pos.y + 95, 130.f, 130.f);
#elif CLIENT_VERSION >= 1001
	g_pRenderText->SetFont(g_hFontBold);
	g_pRenderText->SetTextColor(247, 128, 0, 255);
	g_pRenderText->SetBgColor(0);
	g_pRenderText->RenderText(m_Pos.x + 16, m_Pos.y + 67, Text, 190, 0, RT3_SORT_LEFT);
	g_pRenderText->SetFont(g_hFont);
	g_pRenderText->SetTextColor(255, 255, 255, 255);

	RenderImageScale(IMAGE_GUILDMAKE_FRAME_BOX, m_Pos.x+45, m_Pos.y+60, 118.f, 23.f, 0.f, 0.f, 330.f, 53.f);

	RenderImageScale(IMAGE_GUILDMAKE_FRAME_BOX_BIG, m_Pos.x+ 30, m_Pos.y+ 95, 130.f, 130.f, 0.f, 0.f, 330.f, 212.f);	
#endif
...
void CNewUIGuildMakeWindow::RenderGMResultInfo()
{
	...
	g_pRenderText->SetTextColor(247, 128, 0, 255);
	g_pRenderText->SetBgColor(0);
	g_pRenderText->RenderText(m_Pos.x, m_Pos.y + 140, Text, 190, 0, RT3_SORT_CENTER);
	g_pRenderText->SetFont(g_hFont);
	g_pRenderText->SetTextColor(255, 255, 255, 255);

	RenderImageScale(IMAGE_GUILDMAKE_FRAME_BOX_BIG, m_Pos.x + 66.5f, m_Pos.y + 70, 57.f, 57.f, 0.f, 0.f, 330.f, 212.f);
	CreateGuildMark(MARK_EDIT);
	RenderBitmap(BITMAP_GUILD, m_Pos.x + 71, m_Pos.y + 74, 48, 48);
...
#elif CLIENT_VERSION >= 1001
	//RenderBitmap(IMAGE_GUILDMAKE_BACK_VOID, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.0, 0.0, 0.83, 0.935, 1, 1, 0.0);
	RenderImageScaleAuto(IMAGE_GUILDMAKE_BACK_VOID, m_Pos.x, m_Pos.y, 190.f, 429.f);
