...
namespace SEASON3B
{
	...
	public:
		...
		{		
			...
			IMAGE_ENTERDS_BASE_WINDOW_BACK_VOID = BITMAP_NEW_DEFAULT_WINDOW_BACK,
	...
	private:
		...
		CCustomButtons				m_BtnExit;								// Exit Button Class
		CCustomButtons				m_BtnEnter[MAX_ENTER_GRADE];			// Devil Square Enter Button
