...
BOOL CCustomJewel::CheckCustomJewelApplyItem(int ItemIndex,int TargetItemIndex) // OK
{
	...
	if (gJewelStack.CheckIsStack(ItemIndex)) {
		if (ItemIndex != TargetItemIndex) {
			if (gJewelStack.CheckIsStack(TargetItemIndex)) {
				return 0;
			}
		}
		else {
	...
	if (TargetItemIndex > gItemManager.GET_ITEM(12, 6) && (TargetItemIndex < gItemManager.GET_ITEM(12, 36) || TargetItemIndex > gItemManager.GET_ITEM(12, 43)) && TargetItemIndex != gItemManager.GET_ITEM(12, 49) && TargetItemIndex != gItemManager.GET_ITEM(12, 50) && (TargetItemIndex < gItemManager.GET_ITEM(12, 262) || TargetItemIndex > gItemManager.GET_ITEM(12, 265)) && TargetItemIndex != gItemManager.GET_ITEM(13, 30) && (TargetItemIndex <= gItemManager.GET_ITEM(13, 199) && TargetItemIndex >= gItemManager.GET_ITEM(13, 511)) && gCustomWing.CheckCustomWingByItem(TargetItemIndex) == 0)
	{
		return 0;
	}

	if(lpInfo->EnableSlotWeapon == 0 && (TargetItemIndex >= gItemManager.GET_ITEM(0,0) && TargetItemIndex < gItemManager.GET_ITEM(6,0)))
	{
		return 0;
	}

	if(lpInfo->EnableSlotArmor == 0 && (TargetItemIndex >= gItemManager.GET_ITEM(6,0) && TargetItemIndex < gItemManager.GET_ITEM(12,0)))
	{
		return 0;
	}

	if(lpInfo->EnableSlotWing == 0 && ((TargetItemIndex >= gItemManager.GET_ITEM(12,0) && TargetItemIndex <= gItemManager.GET_ITEM(12,6)) || (TargetItemIndex >= gItemManager.GET_ITEM(12,36) && TargetItemIndex <= gItemManager.GET_ITEM(12,43)) || TargetItemIndex == gItemManager.GET_ITEM(12,49) || TargetItemIndex == gItemManager.GET_ITEM(12,50) || (TargetItemIndex >= gItemManager.GET_ITEM(12,262) && TargetItemIndex <= gItemManager.GET_ITEM(12,265)) || TargetItemIndex == gItemManager.GET_ITEM(13,30) || gCustomWing.CheckCustomWingByItem(TargetItemIndex) != 0))
	{
		return 0;
	}
