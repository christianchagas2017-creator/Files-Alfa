...
namespace SEASON3B
{
	...
	public:
		...
		void SetButtonSize(int size) { m_BtnSize = size; }
		void ForceButtonDown(bool state) { m_BtnForceDown = state; }
	...
	//BUFF ELF ATTACK
	class CBuffElfAttackCancelMsgBoxLayout : public TMsgBoxLayout<CNewUICommonMessageBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT OkBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	...
	//BUFF ELF DEFENSE
	class CBuffElfDefenseCancelMsgBoxLayout : public TMsgBoxLayout<CNewUICommonMessageBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT OkBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	...
	class CBuffSMCancelMsgBoxLayOut : public TMsgBoxLayout<CNewUICommonMessageBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT OkBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	...
	//BUFF BK VITALITY
	class CBuffBKCancelMsgBoxLayOut : public TMsgBoxLayout<CNewUICommonMessageBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT OkBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
	...
	class CBuyVaultMsgBoxLayout : public TMsgBoxLayout<CNewUICommonMessageBox>
	{
	public:
		bool SetLayout();
		static CALLBACK_RESULT OkBtnDown(class CNewUIMessageBoxBase* pOwner, const leaf::xstreambuf& xParam);
