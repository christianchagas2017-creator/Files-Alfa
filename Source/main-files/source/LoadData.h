...
public:
	...
	void AccessModelCustom(int Type, char* Dir, char* FileName,int i=-1);
	void OpenTexture(int Model, char* SubFolder, int Wrap=GL_REPEAT, int Type=GL_NEAREST,bool Check=true);
	void OpenTextureCustom(int Model, char* SubFolder, int Wrap=GL_REPEAT, int Type=GL_NEAREST,bool Check=true);
