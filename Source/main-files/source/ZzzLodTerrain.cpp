...
void RenderFace(int Texture, int mx, int my)
{
	// Set blend mode based on world and texture
	if (gMapManager.WorldActive == WD_39KANTURU_3RD)
	{
		if (Texture == 3)
			EnableAlphaTest();
	...
	// Define the vertex, texture, and color data
	GLfloat vertices[12] = {
		TerrainVertex[0][0], TerrainVertex[0][1], TerrainVertex[0][2],
		TerrainVertex[1][0], TerrainVertex[1][1], TerrainVertex[1][2],
		TerrainVertex[2][0], TerrainVertex[2][1], TerrainVertex[2][2],
		TerrainVertex[3][0], TerrainVertex[3][1], TerrainVertex[3][2]
	};

	GLfloat texCoords[8] = {
		TerrainTextureCoord[0][0], TerrainTextureCoord[0][1],
		TerrainTextureCoord[1][0], TerrainTextureCoord[1][1],
		TerrainTextureCoord[2][0], TerrainTextureCoord[2][1],
		TerrainTextureCoord[3][0], TerrainTextureCoord[3][1]
	};

	GLfloat colors[12] = {
		PrimaryTerrainLight[TerrainIndex1][0], PrimaryTerrainLight[TerrainIndex1][1], PrimaryTerrainLight[TerrainIndex1][2],
		PrimaryTerrainLight[TerrainIndex2][0], PrimaryTerrainLight[TerrainIndex2][1], PrimaryTerrainLight[TerrainIndex2][2],
		PrimaryTerrainLight[TerrainIndex3][0], PrimaryTerrainLight[TerrainIndex3][1], PrimaryTerrainLight[TerrainIndex3][2],
		PrimaryTerrainLight[TerrainIndex4][0], PrimaryTerrainLight[TerrainIndex4][1], PrimaryTerrainLight[TerrainIndex4][2]
	};
...
void RenderFace_After(int Texture, int mx, int my)
{
	// Set blend mode based on texture
	if (Texture == 100)
	{
		EnableAlphaTest();
	}
	...
	// Define vertex, texture coordinate, and color data
	GLfloat vertices[12] = {
		TerrainVertex[0][0], TerrainVertex[0][1], TerrainVertex[0][2], // Vertex 0
		TerrainVertex[1][0], TerrainVertex[1][1], TerrainVertex[1][2], // Vertex 1
		TerrainVertex[2][0], TerrainVertex[2][1], TerrainVertex[2][2], // Vertex 2
		TerrainVertex[3][0], TerrainVertex[3][1], TerrainVertex[3][2]  // Vertex 3
	};

	GLfloat texCoords[8] = {
		TerrainTextureCoord[0][0], TerrainTextureCoord[0][1], // TexCoord 0
		TerrainTextureCoord[1][0], TerrainTextureCoord[1][1], // TexCoord 1
		TerrainTextureCoord[2][0], TerrainTextureCoord[2][1], // TexCoord 2
		TerrainTextureCoord[3][0], TerrainTextureCoord[3][1]  // TexCoord 3
	};

	GLfloat colors[12] = {
		PrimaryTerrainLight[TerrainIndex1][0], PrimaryTerrainLight[TerrainIndex1][1], PrimaryTerrainLight[TerrainIndex1][2], // Color 0
		PrimaryTerrainLight[TerrainIndex2][0], PrimaryTerrainLight[TerrainIndex2][1], PrimaryTerrainLight[TerrainIndex2][2], // Color 1
		PrimaryTerrainLight[TerrainIndex3][0], PrimaryTerrainLight[TerrainIndex3][1], PrimaryTerrainLight[TerrainIndex3][2], // Color 2
		PrimaryTerrainLight[TerrainIndex4][0], PrimaryTerrainLight[TerrainIndex4][1], PrimaryTerrainLight[TerrainIndex4][2]  // Color 3
	};
...
void RenderFaceAlpha(int Texture, int mx, int my)
{
	...
	// Define vertex, texture coordinate, and color (with alpha) data
	GLfloat vertices[12] = {
		TerrainVertex[0][0], TerrainVertex[0][1], TerrainVertex[0][2], // Vertex 0
		TerrainVertex[1][0], TerrainVertex[1][1], TerrainVertex[1][2], // Vertex 1
		TerrainVertex[2][0], TerrainVertex[2][1], TerrainVertex[2][2], // Vertex 2
	...
	GLfloat colors[16] = {
		PrimaryTerrainLight[TerrainIndex1][0], PrimaryTerrainLight[TerrainIndex1][1], PrimaryTerrainLight[TerrainIndex1][2], TerrainMappingAlpha[TerrainIndex1], // Color 0
		PrimaryTerrainLight[TerrainIndex2][0], PrimaryTerrainLight[TerrainIndex2][1], PrimaryTerrainLight[TerrainIndex2][2], TerrainMappingAlpha[TerrainIndex2], // Color 1
		PrimaryTerrainLight[TerrainIndex3][0], PrimaryTerrainLight[TerrainIndex3][1], PrimaryTerrainLight[TerrainIndex3][2], TerrainMappingAlpha[TerrainIndex3], // Color 2
		PrimaryTerrainLight[TerrainIndex4][0], PrimaryTerrainLight[TerrainIndex4][1], PrimaryTerrainLight[TerrainIndex4][2], TerrainMappingAlpha[TerrainIndex4]  // Color 3
	};
	...
	glVertexPointer(3, GL_FLOAT, 0, vertices);
	glTexCoordPointer(2, GL_FLOAT, 0, texCoords);
	glColorPointer(4, GL_FLOAT, 0, colors); // Includes alpha
...
void RenderFaceBlend(int Texture, int mx, int my)
{
	...
	GLfloat colors[12] = {
		TerrainMappingAlpha[TerrainIndex1], TerrainMappingAlpha[TerrainIndex1], TerrainMappingAlpha[TerrainIndex1], // Color 0
		TerrainMappingAlpha[TerrainIndex2], TerrainMappingAlpha[TerrainIndex2], TerrainMappingAlpha[TerrainIndex2], // Color 1
		TerrainMappingAlpha[TerrainIndex3], TerrainMappingAlpha[TerrainIndex3], TerrainMappingAlpha[TerrainIndex3], // Color 2
		TerrainMappingAlpha[TerrainIndex4], TerrainMappingAlpha[TerrainIndex4], TerrainMappingAlpha[TerrainIndex4]  // Color 3
	};
...
void RenderTerrainFace(float xf, float yf, int xi, int yi, float lodf)
{
	...
	if (TerrainFlag != TERRAIN_MAP_GRASS)
	{
		...
		if (TerrainMappingAlpha[TerrainIndex1] >= 1.f &&
			...
			TerrainMappingAlpha[TerrainIndex3] >= 1.f &&
			TerrainMappingAlpha[TerrainIndex4] >= 1.f)
		{
			Texture = TerrainMappingLayer2[TerrainIndex1];
			Alpha = false;
		}
		else
		{
			...
			if (Texture == 5 ||
				(Texture == 11 && (gMapManager.IsPKField() || IsDoppelGanger2())))
			{
				Water = true;
			}
		}
	...
	else
	{
		...
		if (CurrentLayer == 0 && (!gMapManager.InBloodCastle()))
		{
			int Texture = BITMAP_MAPGRASS + TerrainMappingLayer1[TerrainIndex1];
			BITMAP_t* pBitmap = Bitmaps.FindTexture(Texture);
			...
			if (pBitmap)
			{
				...
				// Define vertex, texture coordinate, and color data for the quad
				GLfloat vertices[12] = {
					TerrainVertex[0][0], TerrainVertex[0][1], TerrainVertex[0][2],
					TerrainVertex[1][0], TerrainVertex[1][1], TerrainVertex[1][2],
					TerrainVertex[2][0], TerrainVertex[2][1], TerrainVertex[2][2],
...
void CreateFrustrum2D(vec3_t Position)
{
	...
	{
		Width = 1.0f;//float)GetScreenWidth() / 640.f;
	...
	else
	{
		...
		{
			Width = 1.0f;//(float)GetScreenWidth() / 640.f;// * 0.1f;
		...
		{
			Width = 1.0f;//(float)GetScreenWidth() / 640.f * 1.0f;
		...
		else
		{
			...
			case 0:
				...
				{
					Width = 1.0f;//(float)GetScreenWidth() / 500.f;
				}
				...
				break;
			case 1:
				Width = 1.0f;//(float)GetScreenWidth() / 500.f + 0.1f;// * 0.1f;
...
void RenderTerrainBlock(float xf,float yf,int xi,int yi,bool EditFlag)
{
	...
	if (CameraZoom > 0)
		extraRange -= (15.f * CameraZoom);//Range -= 600.f;

	if (AngleY3D < 0)
		extraRange += 15.f * AngleY3D;
	...
	for(int i=0;i<4;i+=lodi)
	{
		...
		{
            if(TestFrustrum2D(xf+0.5f,yf+0.5f,-50.f+extraRange) || CameraTopViewEnable)
			{
...
void RenderTerrainFrustrum(bool EditFlag)
{
    ...
    for(;yi<=FrustrumBoundMaxY;yi+=4,yf+=4.f)
	{
        ...
        {
            if(TestFrustrum2D(xf+2.f,yf+2.f,g_fFrustumRange-50+extraRange) || CameraTopViewEnable)
			{
#ifdef PJH_NEW_SERVER_SELECT_MAP
				if (gMapManager.WorldActive == WD_73NEW_LOGIN_SCENE)
#else
...
void RenderTerrainFrustrum_After(bool EditFlag)
{
    ...
    for(;yi<=FrustrumBoundMaxY;yi+=4,yf+=4.f)
	{
		...
		for(;xi<=FrustrumBoundMaxX;xi+=4,xf+=4.f)
        {
            if(TestFrustrum2D(xf+2.f,yf+2.f,-130.f+extraRange) || CameraTopViewEnable)
			{
