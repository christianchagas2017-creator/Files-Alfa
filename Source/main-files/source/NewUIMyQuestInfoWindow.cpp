...
void SEASON3B::CNewUIMyQuestInfoWindow::SetPos(int x, int y)
{
	...
	m_btnQuestOpen.ChangeButtonInfo(m_Pos.x + 53, m_Pos.y + 392, 25, 24);
	m_btnQuestGiveUp.ChangeButtonInfo(m_Pos.x + 83, m_Pos.y + 392, 25, 24);
#endif
...
#elif CLIENT_VERSION >= 1001
		RenderImageScaleAuto(IMAGE_MYQUEST_LINE, m_Pos.x + 7.1f, m_Pos.y + 182, 176.f, 10.f);
#endif
...
#elif CLIENT_VERSION >= 1001
		RenderImageScale(IMAGE_MYQUEST_LINE, m_Pos.x + 7.1f, m_Pos.y + 210, 176.f, 10.f, 0.f, 0.f, 404.f, 24.f);
#endif
		RenderCastleInfo();
		RenderTempleInfo();
	}
...
#elif CLIENT_VERSION >= 1001
	LoadBitmap("Interface\\btn_exit.jpg", IMAGE_MYQUEST_BTN_EXIT, GL_LINEAR, GL_REPEAT);
	LoadBitmap("Interface\\newui_msgbox_back.jpg", IMAGE_MYQUEST_BACK, GL_LINEAR);
	LoadBitmap("Interface\\default_window_back.jpg", IMAGE_MYQUEST_BACK_VOID, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back01.tga", IMAGE_MYQUEST_TOP, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back02-L.tga", IMAGE_MYQUEST_LEFT, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back02-R.tga", IMAGE_MYQUEST_RIGHT, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back03.tga", IMAGE_MYQUEST_BOTTOM, GL_LINEAR);

	LoadBitmap("Interface\\division_bar.tga", IMAGE_MYQUEST_LINE, GL_LINEAR);
	LoadBitmap("Interface\\btn_quest_accept.jpg", IMAGE_MYQUEST_BTN_OPEN, GL_LINEAR);
	LoadBitmap("Interface\\btn_quest_leave.jpg", IMAGE_MYQUEST_BTN_GIVE_UP, GL_LINEAR);
	LoadBitmap("Interface\\quest_tab.tga", IMAGE_MYQUEST_TAB_BACK, GL_LINEAR);
	LoadBitmap("Interface\\quest_tab_small.tga", IMAGE_MYQUEST_TAB_SMALL, GL_LINEAR);
	LoadBitmap("Interface\\quest_tab_large.tga", IMAGE_MYQUEST_TAB_BIG, GL_LINEAR);
...
void SEASON3B::CNewUIMyQuestInfoWindow::UnloadImages()
{
	...
	DeleteBitmap(IMAGE_MYQUEST_BACK_VOID);
#endif
}
...
#elif CLIENT_VERSION >= 1001
	//RenderBitmap(IMAGE_MYQUEST_BACK_VOID, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.0, 0.0, 0.83, 0.935, 1, 1, 0.0);
	RenderImageScaleAuto(IMAGE_MYQUEST_BACK_VOID, m_Pos.x, m_Pos.y, 190.f, 429.f);
#endif
}
...
#elif CLIENT_VERSION >= 1001
	RenderImageScaleAuto(IMAGE_MYQUEST_LINE, m_Pos.x + 7.1f, m_Pos.y + 160, 176.f, 10.f);
#endif
...
#elif CLIENT_VERSION >= 1001
	RenderImageScale(IMAGE_MYQUEST_TAB_BACK, m_Pos.x+10, m_Pos.y+27, 166.f, 22.f, 0.f, 0.f, 332.f, 44.f);
#endif
...
#elif CLIENT_VERSION >= 1001
		RenderImageScale(IMAGE_MYQUEST_TAB_SMALL, m_Pos.x + 11.5f, m_Pos.y + 32, 45.f, 16.f, 0.f, 0.f, 89.f, 30.f);
#endif
		g_pRenderText->SetTextColor(255, 255, 255, 255);
...
#elif CLIENT_VERSION >= 1001
		RenderImageScale(IMAGE_MYQUEST_TAB_SMALL, m_Pos.x + 58.8f, m_Pos.y + 32, 45.f, 16.f, 0.f, 0.f, 89.f, 30.f);
#endif
		g_pRenderText->SetTextColor(255, 255, 255, 255);
...
#elif CLIENT_VERSION >= 1001
		RenderImageScale(IMAGE_MYQUEST_TAB_BIG, m_Pos.x + 106.5f, m_Pos.y + 32, 68.f, 16.f, 0.f, 0.f, 136.f, 30.f);
#endif
		g_pRenderText->SetTextColor(255, 255, 255, 255);
...
#elif CLIENT_VERSION >= 1001
		m_btnQuestOpen.ForceButtonDisabled(false);
...
#elif CLIENT_VERSION >= 1001
		m_btnQuestOpen.ForceButtonDisabled(true);
...
#elif CLIENT_VERSION >= 1001
		m_btnQuestGiveUp.ForceButtonDisabled(false);
...
#elif CLIENT_VERSION >= 1001
		m_btnQuestGiveUp.ForceButtonDisabled(true);
