...
void CDuelMgr::SetGuild(int iPlayerNum, char * guildName)
{
	strncpy(m_DuelPlayer[iPlayerNum].GuildName, guildName, MAX_ID_SIZE);
	m_DuelPlayer[iPlayerNum].GuildName[MAX_ID_SIZE] = '\0';
}
...
char * CDuelMgr::GetGuild(int iPlayerNum)
{
	return m_DuelPlayer[iPlayerNum].GuildName;
}
