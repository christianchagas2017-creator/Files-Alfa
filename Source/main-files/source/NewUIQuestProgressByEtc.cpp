...
void CNewUIQuestProgressByEtc::LoadImages()
{
	...
	LoadBitmap("Interface\\btn_exit.jpg", IMAGE_QPE_BTN_CLOSE, GL_LINEAR, GL_REPEAT);
	LoadBitmap("Interface\\newui_msgbox_back.jpg", IMAGE_QPE_BACK, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back04.tga", IMAGE_QPE_TOP, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back02-L.tga", IMAGE_QPE_LEFT, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back02-R.tga", IMAGE_QPE_RIGHT, GL_LINEAR);
	...
	LoadBitmap("Interface\\division_bar.tga", IMAGE_QPE_LINE, GL_LINEAR);
	LoadBitmap("Interface\\btn_previous.jpg", IMAGE_QPE_BTN_L, GL_LINEAR);
	LoadBitmap("Interface\\btn_next.jpg", IMAGE_QPE_BTN_R, GL_LINEAR);
	LoadBitmap("Interface\\btn_large.jpg", IMAGE_QPE_BTN_COMPLETE, GL_LINEAR);
#endif
}
