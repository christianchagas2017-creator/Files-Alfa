...
void SEASON3B::CNewUICursedTempleSystem::LoadImages()
{
	...
	//prorogress, npctalk
	LoadBitmap("Interface\\messagebox_top.tga", IMAGE_CURSEDTEMPLESYSTEM_TOP, GL_LINEAR);
	LoadBitmap("Interface\\messagebox_middle.tga", IMAGE_CURSEDTEMPLESYSTEM_MIDDLE, GL_LINEAR);
	LoadBitmap("Interface\\messagebox_bottom.tga", IMAGE_CURSEDTEMPLESYSTEM_BOTTOM, GL_LINEAR);
	LoadBitmap("Interface\\newui_msgbox_back.jpg", IMAGE_CURSEDTEMPLESYSTEM_BACK, GL_LINEAR);
	LoadBitmap("Interface\\btn_small.jpg", IMAGE_CURSEDTEMPLESYSTEM_BTN, GL_LINEAR);
