...
namespace SEASON3B
{
	...
	public:
		enum IMAGE_LIST
		{
			...
			IMAGE_ND_BACK_VOID = BITMAP_NEW_DEFAULT_WINDOW_BACK,
#endif
	...
	private:
		...
		CCustomButtons		m_btnProgressL;
		CCustomButtons		m_btnProgressR;
		CCustomButtons		m_btnSelTextL;
		CCustomButtons		m_btnSelTextR;
		CCustomButtons		m_btnClose;
#endif
