...
{
	BMD* b = &Models[o->Type];
	if (b->NumMeshs == 0 && o->Type < gItemManager.GET_ITEM_MODEL(16, 0) && o->Type != MODEL_PLAYER)
	{
		if (gCustomWing.CheckCustomWingByItem(o->Type - MODEL_ITEM)) {
			gCustomWing.LoadWing(o->Type);
		}
		else
		{
			gItemManager.LoadItem(o->Type);
		}
		return;
	}
	bool View = true;
	...
	if ((EditFlag != EDIT_NONE) || (EditFlag == EDIT_NONE && o->HiddenMesh != -2))
	{
		if (ExtraMon != 10)
		{
			if (b)
			{
				if (gHelperSystem.CheckIsHelper(o->Type))
				{
				...
				else if (o->Type >= gItemManager.GET_ITEM_MODEL(18, 255) && o->Type < gItemManager.GET_ITEM_MODEL(19, 0))
				{
					gPatente.PatentModelRender(DWORD(b), (DWORD)(o), o->Type);
					return;
				}
			}
		}
		...
		else if (o->Type == MODEL_MONSTER01 + 168)
		{
			...
			else
			{
										...
										if (o->Type == MODEL_NPC_QUARREL)
										{
											...
											if (o->Type == MODEL_SEED_MASTER)
											{
												...
												if (o->Type == MODEL_MONSTER01 + 45)
												{
													...
													{
														gPatente.GMSignRender((DWORD)b, (DWORD)o);
													}
													...
													else if (o->Type == MODEL_FENRIR_THUNDER || o->Type == MODEL_FENRIR_THUNDER2) //EFEITO DE RAIOS
													{
														if (o->SubType == 1 || o->SubType == 4 || o->SubType == 5 || o->SubType == 10 || o->SubType == 12 || o->SubType == 13 || o->SubType == 18)
														{
															VectorCopy(o->Light, b->BodyLight);
															b->RenderBody(RENDER_TEXTURE, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, o->HiddenMesh);
															Vector(1.f, 1.f, 1.f, b->BodyLight);
														}
														else if (o->SubType == 6 || o->SubType == 7 || o->SubType == 8 || o->SubType == 11 || o->SubType == 14 || o->SubType == 15 || o->SubType == 16 || o->SubType == 17 || o->SubType == 19)
														{
															VectorCopy(o->Light, b->BodyLight);
															b->RenderBody(RENDER_TEXTURE | RENDER_DARK, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, o->HiddenMesh);
															Vector(1.f, 1.f, 1.f, b->BodyLight);
													...
													else if (o->Type >= MODEL_SUMMONER_CASTING_EFFECT1 && o->Type <= MODEL_SUMMONER_CASTING_EFFECT4) //CASTING EFFECT
													{
														VectorCopy(o->Light, b->BodyLight);
														if (o->SubType == 1)
															b->RenderBody(RENDER_TEXTURE | RENDER_BRIGHT | RENDER_DARK, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, -1);
														else
													...
													else if (o->Type == MODEL_FEATHER) //EFEITO DE PENAS
													{
														if (o->SubType == 2 || o->SubType == 3)
														{
															b->RenderBody(RENDER_TEXTURE | RENDER_DARK, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, o->HiddenMesh);
														}
														else if (o->SubType == 4 || o->SubType == 5 || o->SubType == 6 || o->SubType == 7) //EFEITO DE PENAS NOVOS
														{
															VectorCopy(o->Light, b->BodyLight);
													...
													else if (o->Type == MODEL_ARROW_GAMBLE) //EFEITO FLECHA 508
													{
														if (o->SubType == 2)
														{
															b->RenderMesh(0, RENDER_TEXTURE | RENDER_DARK, o->Alpha, 0, o->Alpha, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, o->HiddenMesh);
														}
														//else if (o->SubType == 1) 
														//{
														//	VectorCopy(o->Light, b->BodyLight);
				...
				else if (o->Type == MODEL_DEATH_SCYTHE) //DEATH SCYTHE
				{
					...
					else if (o->SubType == 2)
					{
						//Vector(1.f, 1.f, 1.f, b->BodyLight);
						VectorCopy(o->Light, b->BodyLight);
						b->RenderBody(RENDER_TEXTURE | RENDER_DARK, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, -1);
						b->RenderBody(RENDER_TEXTURE | RENDER_DARK, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, -1);
						b->RenderBody(RENDER_TEXTURE | RENDER_DARK, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, -1);
					}
					else
	...
	for (int i = 0; i < MAX_ITEMS; i++)
	{
		...
		if (o->Live)
		{
			...
			if (o->Visible)
			{
				...
				BMD* b = &Models[Type];
				if (b->NumMeshs == 0 && Type < gItemManager.GET_ITEM_MODEL(16, 0) && Type != MODEL_PLAYER)
				{
					if (gCustomWing.CheckCustomWingByItem(o->Type - MODEL_ITEM)) {
						gCustomWing.LoadWing(o->Type);
					}
...
void RenderPartObjectBody(BMD* b, OBJECT* o, int Type, float Alpha, int RenderType)
{
	...
	if (BMDStruct->NumMeshs == 0 && Type < gItemManager.GET_ITEM_MODEL(16, 0) && Type != MODEL_PLAYER)
	{
		if (gCustomWing.CheckCustomWingByItem(Type - MODEL_ITEM)) {
			gCustomWing.LoadWing(Type);
		}
		else
		{
			gItemManager.LoadItem(Type);
		}
		return;
	}
		...
		o->Type == MODEL_15GRADE_ARMOR_OBJ_PANTRIGHT)
	{
		...
		if (o->SubType == 0) //EFEITO 15 PADRÃO
		{
		...
		else if (o->SubType == 1) //EFEITO 15 COLORIDO
		{
			VectorCopy(o->Light, b->BodyLight);
			float fLight, texCoordU;
		...
		else if (o->SubType == 2) //EFEITO 15 DARK/PRETO
		{
			float fLight, texCoordU;

			fLight = 0.8f;
			b->RenderMesh(0, RENDER_TEXTURE | RENDER_BRIGHT | RENDER_DARK, o->Alpha, 0, fLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV);
			texCoordU = absf(sinf(WorldTime * 0.0005f));
			b->RenderMesh(0, RENDER_TEXTURE | RENDER_BRIGHT | RENDER_DARK, o->Alpha, 0, fLight, texCoordU, o->BlendMeshTexCoordV);
			//b->RenderMesh(0, RENDER_TEXTURE | RENDER_CHROME4 | RENDER_DARK, o->Alpha, 0, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV);
		}
		else if (o->SubType == 3) //EFEITO 15 DARK/PRETO (RENDER)
		{
			float fLight, texCoordU;

			fLight = 1.f - absf(sinf(WorldTime * 0.0018f) * 0.5f);
			b->RenderMesh(0, RENDER_TEXTURE | RENDER_BRIGHT | RENDER_DARK, o->Alpha, 0, fLight - 0.1f, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV);
			texCoordU = absf(sinf(WorldTime * 0.0005f));
			b->RenderMesh(0, RENDER_TEXTURE | RENDER_BRIGHT | RENDER_DARK, o->Alpha, 0, fLight - 0.2f, texCoordU, o->BlendMeshTexCoordV);
			//b->RenderMesh(0, RENDER_TEXTURE | RENDER_CHROME4 | RENDER_DARK, o->Alpha, 0, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV);
		}
	}
	else
...
void RenderPartObjectBodyColor(BMD* b, OBJECT* o, int Type, float Alpha, int RenderType, float Bright, int Texture, int iMonsterIndex)
{
	...
	{
		bool hadItem = false;
		for (std::vector<MESH_GLOW>::iterator it = gCustomMeshGlow.m_MeshList.begin(); it != gCustomMeshGlow.m_MeshList.end(); it++)
		{
			if (it->ItemIndex == Type)
			{
				b->RenderMesh(it->Mesh, RenderType, o->Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV);
				hadItem = true;
			}
		}
...
void RenderPartObjectBodyColor2(BMD* b, OBJECT* o, int Type, float Alpha, int RenderType, float Bright, int Texture)
{
	...
	else
	{
		...
		//gItemManager.GetItemColor2(Type,Alpha,Bright,b->BodyLight, (RenderType&RENDER_EXTRA) ? true : false );
	}
	if (Type == MODEL_STAFF + 5)
		b->RenderBody(RenderType, Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV, 1, Texture);
	else if (Type == MODEL_SWORD + 20)
...
void NextGradeObjectRender(CHARACTER* c)
{
	...
	int Level;
	PART_t* w;
	BMD* rtype = &Models[c->Object.RenderType];
	...
	for (int i = 0; i < 2; i++)
	{
		...
		if (!gCCustomSetEffect.GetEffect15Grade(c, w->Type - MODEL_ITEM)) continue;
	...
	for (int k = 0; k < MAX_BODYPART; k++)
	{
		...
		for (int m = 0; m < 2; m++)
		{
			...
			case 15: // +15 //EFEITO 15 COLOR
			{
				...
				/*
				w->LinkBone = bornIndex[m];
				RenderLinkObject(0.f, 0.f, 0.f, c, w, gradeType[m], 0, 0, true, true, o->RenderType);
				...
				//Vector(0.7f*fLight2, 0.7f*fLight2, 0.7f*fLight2, vLight);
				//Vector(fLight2 * 1.f, fLight2 * 1.f, fLight2 * 1.f, vLight);

				CreateSprite(BITMAP_MAGIC, vPos, 0.12f, vLight, o, 0, 1);

				Vector(0.4f, 0.7f, 1.0f, vLight);
				CreateSprite(BITMAP_SHINY+5, vPos, 0.4f, vLight, o, 0, 1);

				Vector(0.1f, 0.3f, 1.0f, vLight);
				CreateSprite(BITMAP_PIN_LIGHT, vPos, 0.6f, vLight, o, 90.0f, 1);
				*/
			}break;
			}
		}
...
void RenderPartObjectEffect(OBJECT* o, int Type, vec3_t Light, float Alpha, int ItemLevel, int Option1, int ExtOption, int Select, int RenderType)
{
	...
	if (!o->EnableShadow)
	{
		...
		if (g_isCharacterBuff(o, eBuff_Cloaking)) //HIDE EFEITO ATIVADO
		{
			Alpha = 0.5f;
			Vector(1.f, 1.f, 1.f, b->BodyLight);
		...
		if (gCustomWing.CheckCustomWingByItem(Type - MODEL_ITEM) == 1) //WING EXCELENT
		{
			return;
		}
				...
				if ((Option1 & 63) > 0 && (o->Type<MODEL_WING || o->Type>MODEL_WING + 6) && o->Type != MODEL_HELPER + 30 && (o->Type<MODEL_WING + 36 || o->Type>MODEL_WING + 43) && (o->Type < MODEL_WING + 130 || MODEL_WING + 134 < o->Type))
				{
					...
					else
					{
						...
						for (std::vector<MESH_GLOW>::iterator it = gCustomMeshGlow.m_MeshList.begin(); it != gCustomMeshGlow.m_MeshList.end(); it++)
						{
							if (it->ItemIndex == Type)
							{
								b->RenderMesh(it->Mesh, RENDER_TEXTURE | RENDER_BRIGHT, Alpha, o->BlendMesh, o->BlendMeshLight, o->BlendMeshTexCoordU, o->BlendMeshTexCoordV);
								hadItem = true;
							}
						}
...
void RenderPartObjectEdge(BMD* b, OBJECT* o, int Flag, bool Translate, float Scale, int ItemIndex)
{
	if (g_isCharacterBuff(o, eBuff_Cloaking))
	{
		return;
	...
	{
		if (gItemEdge.RenderItemEdge(b, o, ItemIndex) != 1)
...
void RenderPartObject(OBJECT* o, int Type, void* p2, vec3_t Light, float Alpha, int ItemLevel, int Option1, int ExtOption, bool GlobalTransform, bool HideSkin, bool Translate, int Select, int RenderType)
{
	...
	else if (1 == Select)
	{
		...
		RenderPartObjectEdge(b, o, RENDER_BRIGHT, Translate, Scale, Type);
		if (o->Kind == KIND_NPC)
		{
			Vector(0.16f, 0.7f, 0.f, b->BodyLight);
		}
		...
		RenderPartObjectEdge(b, o, RENDER_BRIGHT, Translate, Scale - 0.02f, Type);
	}
	BodyLight(o, b);
	...
	if (p)
	{
		...
		switch (Type)
		{
		case MODEL_PANTS + 18:  //PANTS GRAND SOUL
		case MODEL_PANTS + 113: //PANTS GRAND SOUL BLACK
			iCloth = 1;
			break;
		case MODEL_PANTS + 19:  //PANTS DIVINE
			iCloth = 2;
			break;
		case MODEL_PANTS + 22:  //PANTS DARKS SOUL/SIDE
			iCloth = 3;
			break;
		case MODEL_PANTS + 52:  //PANTS HADES
			//case MODEL_PANTS + 88:  //PANTS WAR 1.0
			iCloth = 4;
			break;
		}
		...
		if (!p->m_pCloth[0] && iCloth > 0)
		{
			...
			switch (iCloth)
			{
				//PANTS GRAND SOUL E GRAND SOUL BLACK
			case 1:
			...
			case 4:
				iCount = 1;
				pCloth[0] = new CPhysicsClothMesh;
				pCloth[0]->Create(o, 1, 2, PCT_OPT_CORRECTEDFORCE | PCT_HEAVY, Type);
				pCloth[0]->AddCollisionSphere(0.0f, 0.0f, -15.0f, 22.0f, 2);
				pCloth[0]->AddCollisionSphere(0.0f, 0.0f, -27.0f, 23.0f, 2);
				pCloth[0]->AddCollisionSphere(0.0f, 0.0f, -40.0f, 24.0f, 2);
				pCloth[0]->AddCollisionSphere(0.0f, 0.0f, -54.0f, 25.0f, 2);
			...
			//Create Mesh, Bone, X(left/right), Y(front/back), Z(top/bottom), NumHorizontal, NumVertical, Width, Heith, Texture Front, Texture Back, dwType, BMDType
			//AddCollisionSphere X, Y, Z, Radius, Bone
