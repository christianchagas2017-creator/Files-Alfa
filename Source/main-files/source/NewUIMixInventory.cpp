...
bool CNewUIMixInventory::Create(CNewUIManager* pNewUIMng, int x, int y)
{
	...
	POINT ptBtn = { m_Pos.x + (long)INVENTORY_WIDTH * (long)0.5f - (long)16, m_Pos.y + (long)380 };
	m_BtnMix.ChangeButtonImgState(true, IMAGE_MIXINVENTORY_MIXBTN, false);
	m_BtnMix.SetButtonSize(3);
	m_BtnMix.ChangeButtonInfo(m_Pos.x + INVENTORY_WIDTH * 0.5f - 16.f, m_Pos.y + 380, 32.f, 32.f);
#endif
...
void CNewUIMixInventory::LoadImages()
{
	...
	LoadBitmap("Interface\\newui_item_back02-R.tga", IMAGE_MIXINVENTORY_RIGHT, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back03.tga", IMAGE_MIXINVENTORY_BOTTOM, GL_LINEAR);
	LoadBitmap("Interface\\btn_mix.jpg", IMAGE_MIXINVENTORY_MIXBTN, GL_LINEAR);
	LoadBitmap("Interface\\default_window_back.jpg", IMAGE_MIXINVENTORY_BACK_VOID, GL_LINEAR);
...
void CNewUIMixInventory::UnloadImages()
{
	...
	DeleteBitmap(IMAGE_MIXINVENTORY_BACK_VOID);
#endif
...
#elif  CLIENT_VERSION >= 1001
	//RenderBitmap(IMAGE_MIXINVENTORY_BACK_VOID, m_Pos.x, m_Pos.y, INVENTORY_WIDTH, INVENTORY_HEIGHT, 0.0, 0.0, 0.83, 0.935, 1, 1, 0.0);
	RenderImageScaleAuto(IMAGE_MIXINVENTORY_BACK_VOID, m_Pos.x, m_Pos.y, INVENTORY_WIDTH, INVENTORY_HEIGHT);
#endif
