		...
		if (!o->Live)
		{
			...
			case BITMAP_FLAME:
				...
				case 6:
					...
					o->Scale = Scale * (float)(rand() % 64 + 64) * 0.2f;
					break;
				case 8:
				case 7:
				{
			...
			case BITMAP_SMOKE:
				...
				case 62:
				{
					...
					o->Scale = o->Scale;
					o->Position[0] += ((float)(rand() % 64 - 32)) * FPS_ANIMATION_FACTOR;
					o->Position[1] += ((float)(rand() % 64 - 32)) * FPS_ANIMATION_FACTOR;    					o->Position[1] += (float)(rand() % 64 - 32);
					o->Angle[0] = (float)(rand() % 90 - 45);
					o->Angle[2] = (float)(rand() % 360);
					Vector(0.f, -(float)(rand() % 8), 0.f, o->Velocity);
				}
			...
			case BITMAP_LIGHT:
				...
				else if (o->SubType == 4 || o->SubType >= 100) //BUFF BK (NÃO SEI)
				{
					o->LifeTime = 10;
					o->Gravity = 0.f;
					o->Rotation = Scale;
	...
	for (int i = 0;i < MAX_PARTICLES;i++)
	{
		...
		if (o->Live)
		{
			...
			case BITMAP_FLARE_RED:
				...
				HandPosition(o);
				break;
			case BITMAP_CLUD64: //EFEITO PRETO
			{
				if (o->SubType == 0)
				{
					Luminosity = (float)(o->LifeTime) / 10.f;
            ...
            case BITMAP_LIGHT:
				...
				else if (o->SubType == 4 || o->SubType >= 100) //BUFF BK
				{
					...
					o->Gravity += ((rand() % 40 + 60) / 15.f * 0.0f) * FPS_ANIMATION_FACTOR;
					o->Scale -= FPS_ANIMATION_FACTOR * (rand() % 90 + 90) / 50000.f;
					o->Position[2] += o->Gravity * FPS_ANIMATION_FACTOR;
					...
					if (o->SubType >= 100)
					{
						...
						{
							gBuffColorBK.GetBuffColorBK3(o->SubType, Light); //BUFF BK COLOR (NÃO SEI)
						}
					}
					else
					{
						o->Light[0] *= powf(1.0f / (2.900f), FPS_ANIMATION_FACTOR);
						o->Light[1] *= powf(1.0f / (2.900f), FPS_ANIMATION_FACTOR);
						o->Light[2] *= powf(1.0f / (2.900f), FPS_ANIMATION_FACTOR);
					}
				}
                else if (o->SubType == 9)
                {
