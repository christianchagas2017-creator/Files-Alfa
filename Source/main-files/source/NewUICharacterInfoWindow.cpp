...
bool SEASON3B::CNewUICharacterInfoWindow::Create(CNewUIManager* pNewUIMng, int x, int y)
{
	...
	m_MoveWindow.Create(x, y, CHAINFO_WINDOW_WIDTH, CHAINFO_WINDOW_HEIGHT);
...
void SEASON3B::CNewUICharacterInfoWindow::SetButtonInfo()
{
	...
	m_BtnStat[STAT_STRENGTH].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false);
	m_BtnStat[STAT_STRENGTH].ChangeButtonInfo(m_Pos.x + 158, m_Pos.y + HEIGHT_STRENGTH + 2, 19, 18);

	m_BtnStat[STAT_DEXTERITY].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false);
	m_BtnStat[STAT_DEXTERITY].ChangeButtonInfo(m_Pos.x + 158, m_Pos.y + HEIGHT_DEXTERITY + 2, 19, 18);

	m_BtnStat[STAT_VITALITY].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false);
	m_BtnStat[STAT_VITALITY].ChangeButtonInfo(m_Pos.x + 158, m_Pos.y + HEIGHT_VITALITY + 2, 19, 18);

	m_BtnStat[STAT_ENERGY].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false);
	m_BtnStat[STAT_ENERGY].ChangeButtonInfo(m_Pos.x + 158, m_Pos.y + HEIGHT_ENERGY + 2, 19, 18);

	m_BtnStat[STAT_CHARISMA].ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_STAT, false);
	m_BtnStat[STAT_CHARISMA].ChangeButtonInfo(m_Pos.x + 158, m_Pos.y + HEIGHT_CHARISMA + 2, 19, 18);
	...
	m_BtnExit.ChangeToolTipText(strText, true);
	//m_BtnQuest.ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_QUEST, false);
	//m_BtnQuest.ChangeButtonInfo(m_Pos.x + 53, m_Pos.y + 392, 25, 24);
	//unicode::_sprintf(strText, "%s(%s)", GlobalText[1140], "T");
	//m_BtnQuest.ChangeToolTipText(strText, true);
	//m_BtnPet.ChangeButtonImgState(true, IMAGE_CHAINFO_BTN_PET, false);
	//m_BtnPet.ChangeButtonInfo(m_Pos.x + 83, m_Pos.y + 392, 25, 24);
	//m_BtnPet.ChangeToolTipText(GlobalText[1217], true);
#endif
...
#elif CLIENT_VERSION >= 1001
	//RenderBitmap(IMAGE_CHAINFO_BACK_VOID, m_Pos.x, m_Pos.y, 190.f, 429.f, 0.0, 0.0, 0.83, 0.935, 1, 1, 0.0);
	RenderImageScaleAuto(IMAGE_CHAINFO_BACK_VOID, m_Pos.x, m_Pos.y, 190.f, 429.f);
	RenderImageScale(IMAGE_CHAINFO_FRAME_BOX, m_Pos.x + 10, m_Pos.y + 46, 168, 24, 0.f, 0.f, 330.f, 53.f);
	RenderImageScale(IMAGE_CHAINFO_FRAME_BOX_LARGE, m_Pos.x + 10, m_Pos.y + 69.5f, 168, 46, 0.f, 0.f, 330.f, 106.f);
	if (CharacterAttribute->LevelUpPoint > 0)
	{
		RenderImageScale(IMAGE_CHAINFO_POINTS_BAR, m_Pos.x + 100, m_Pos.y + 49, 75, 18, 0.f, 0.f, 160.f, 40.f);
	}

	RenderBitmap(IMAGE_CHAINFO_TEXTBOX, m_Pos.x + 10, m_Pos.y + HEIGHT_STRENGTH, 168.f, 21, 0.002, 0.0, 0.640, 0.818956, 1, 1, 1.0);
	RenderBitmap(IMAGE_CHAINFO_TEXTBOX, m_Pos.x + 10, m_Pos.y + HEIGHT_DEXTERITY, 168.f, 21, 0.002, 0.0, 0.640, 0.818956, 1, 1, 1.0);
	RenderBitmap(IMAGE_CHAINFO_TEXTBOX, m_Pos.x + 10, m_Pos.y + HEIGHT_VITALITY, 168.f, 21, 0.002, 0.0, 0.640, 0.818956, 1, 1, 1.0);
	RenderBitmap(IMAGE_CHAINFO_TEXTBOX, m_Pos.x + 10, m_Pos.y + HEIGHT_ENERGY, 168.f, 21, 0.002, 0.0, 0.640, 0.818956, 1, 1, 1.0);
#if CLIENT_VERSION == 1001
	if (gCharacterManager.GetBaseClass(Hero->Class) == CLASS_DARK_LORD)
	{
		RenderBitmap(IMAGE_CHAINFO_TEXTBOX, m_Pos.x + 10, m_Pos.y + HEIGHT_CHARISMA, 168.f, 21, 0.002, 0.0, 0.640, 0.818956, 1, 1, 1.0);
	}
#endif
#endif
}
...
void SEASON3B::CNewUICharacterInfoWindow::RenderSubjectTexts()
{
	...
	float fAlpha = sinf(WorldTime * 0.001f) + 1.f;
	g_pRenderText->SetTextColor(255, 255, 255, 127 * (2.f - fAlpha));
	g_pRenderText->RenderText(m_Pos.x, m_Pos.y + 23, strClassName, 190, 0, RT3_SORT_CENTER);
	g_pRenderText->SetTextColor(255, 255, 255, 127 * fAlpha);
	g_pRenderText->RenderText(m_Pos.x, m_Pos.y + 23, strServerName, 190, 0, RT3_SORT_CENTER);
#endif
...
#elif CLIENT_VERSION >= 1001
	g_pRenderText->SetTextColor(200, 200, 155, 255);
	g_pRenderText->RenderText(m_Pos.x+18, m_Pos.y+54, strLevel);
...
#elif CLIENT_VERSION >= 1001
		g_pRenderText->SetTextColor(200, 200, 155, 255);
		g_pRenderText->RenderText(m_Pos.x+107, m_Pos.y+54, strLevelUpPoint);
...
#elif CLIENT_VERSION >= 1001
	g_pRenderText->SetBgColor(0, 0, 0, 110);
...
#elif CLIENT_VERSION >= 1001
	g_pRenderText->RenderText(m_Pos.x+20, m_Pos.y+HEIGHT_STRENGTH+25, strAttakMamage, 138.f);
...
#elif CLIENT_VERSION >= 1001
		g_pRenderText->RenderText(m_Pos.x + 20, m_Pos.y + iY, strAttakMamage, 138.f);
...
#elif CLIENT_VERSION >= 1001
	g_pRenderText->RenderText(m_Pos.x+20, m_Pos.y+iY, strBlocking, 138.f);
...
#elif CLIENT_VERSION >= 1001
	g_pRenderText->RenderText(m_Pos.x + 20, m_Pos.y + iY, strVitality, 138.f);
...
#elif CLIENT_VERSION >= 1001
	g_pRenderText->RenderText(m_Pos.x + 20, m_Pos.y + iY, strEnergy, 138.f);
...
#if (CLIENT_VERSION >= 401 && CLIENT_VERSION <= 502) || CLIENT_VERSION == 1001
	if(iBaseClass == CLASS_DARK_LORD)
	{
		g_pRenderText->SetFont(g_hFontBold);
		g_pRenderText->SetBgColor(0);
...
void SEASON3B::CNewUICharacterInfoWindow::RenderButtons()
{
	...
	//	m_BtnPet.ForceButtonDown(true);
	//}
	//else {
	//	m_BtnPet.ForceButtonDown(false);
	//}
	//
	//if (g_pNewUISystem->IsVisible(SEASON3B::INTERFACE_MYQUEST)) {
	//	m_BtnQuest.ForceButtonDown(true);
	//}
	//else {
	//	m_BtnQuest.ForceButtonDown(false);
	//}
#endif
...
void SEASON3B::CNewUICharacterInfoWindow::LoadImages()
{
...
#elif CLIENT_VERSION >= 1001
	LoadBitmap("Interface\\btn_exit.jpg", IMAGE_CHAINFO_BTN_EXIT, GL_LINEAR, GL_REPEAT);
	LoadBitmap("Interface\\newui_msgbox_back.jpg", IMAGE_CHAINFO_BACK, GL_LINEAR);
	LoadBitmap("Interface\\default_window_back.jpg", IMAGE_CHAINFO_BACK_VOID, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back04.tga", IMAGE_CHAINFO_TOP, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back02-L.tga", IMAGE_CHAINFO_LEFT, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back02-R.tga", IMAGE_CHAINFO_RIGHT, GL_LINEAR);
	LoadBitmap("Interface\\newui_item_back03.tga", IMAGE_CHAINFO_BOTTOM, GL_LINEAR);
	...
	LoadBitmap("Interface\\item_money_2.jpg", IMAGE_CHAINFO_TEXTBOX, GL_LINEAR);
	LoadBitmap("Interface\\btn_plus.jpg", IMAGE_CHAINFO_BTN_STAT, GL_LINEAR);
	LoadBitmap("Interface\\btn_quest.jpg", IMAGE_CHAINFO_BTN_QUEST, GL_LINEAR);
	LoadBitmap("Interface\\btn_mascote.jpg", IMAGE_CHAINFO_BTN_PET, GL_LINEAR);
	LoadBitmap("Interface\\btn_skilltree.jpg", IMAGE_CHAINFO_BTN_MASTERLEVEL, GL_LINEAR);
	LoadBitmap("Interface\\store_name.jpg", IMAGE_CHAINFO_FRAME_BOX, GL_LINEAR);
	LoadBitmap("Interface\\store_name_large.jpg", IMAGE_CHAINFO_FRAME_BOX_LARGE, GL_LINEAR);
	LoadBitmap("Interface\\points_bar.jpg", IMAGE_CHAINFO_POINTS_BAR, GL_LINEAR);
...
#if CLIENT_VERSION >= 1001
	DeleteBitmap(IMAGE_CHAINFO_BACK_VOID);
	DeleteBitmap(IMAGE_CHAINFO_FRAME_BOX);
	DeleteBitmap(IMAGE_CHAINFO_FRAME_BOX_LARGE);
	DeleteBitmap(IMAGE_CHAINFO_POINTS_BAR);
#endif
...
void SEASON3B::CNewUICharacterInfoWindow::ResetMouseRButton()
{
	MouseRButton = false;
...
#elif CLIENT_VERSION >= 1001
		m_BtnMasterLevel.ForceButtonDisabled(false);
...
#elif CLIENT_VERSION >= 1001
		m_BtnMasterLevel.ForceButtonDisabled(true);
...
void SEASON3B::CNewUICharacterInfoWindow::ResetEquipmentLevel()
{
	...
	Hero->Weapon[0].Level = (pItem[(pItem[NEW_EQUIPMENT_WEAPON_RIGHT].Type != -1 ? NEW_EQUIPMENT_WEAPON_RIGHT : EQUIPMENT_WEAPON_RIGHT)].Level>>3)&15;
	Hero->Weapon[1].Level = (pItem[(pItem[NEW_EQUIPMENT_WEAPON_LEFT].Type != -1 ? NEW_EQUIPMENT_WEAPON_LEFT : EQUIPMENT_WEAPON_LEFT)].Level>>3)&15;
	Hero->BodyPart[BODYPART_HELM].Level = (pItem[(pItem[NEW_EQUIPMENT_HELM].Type != -1 ? NEW_EQUIPMENT_HELM : EQUIPMENT_HELM)].Level >> 3) & 15;
	Hero->BodyPart[BODYPART_ARMOR].Level = (pItem[(pItem[NEW_EQUIPMENT_ARMOR].Type != -1 ? NEW_EQUIPMENT_ARMOR : EQUIPMENT_ARMOR)].Level>>3)&15;
	Hero->BodyPart[BODYPART_PANTS].Level = (pItem[(pItem[NEW_EQUIPMENT_PANTS].Type != -1 ? NEW_EQUIPMENT_PANTS : EQUIPMENT_PANTS)].Level>>3)&15;
	Hero->BodyPart[BODYPART_GLOVES].Level = (pItem[(pItem[NEW_EQUIPMENT_GLOVES].Type != -1 ? NEW_EQUIPMENT_GLOVES : EQUIPMENT_GLOVES)].Level>>3)&15;
	Hero->BodyPart[BODYPART_BOOTS].Level = (pItem[(pItem[NEW_EQUIPMENT_BOOTS].Type != -1 ? NEW_EQUIPMENT_BOOTS : EQUIPMENT_BOOTS)].Level>>3)&15;

	if (pItem[NEW_EQUIPMENT_WEAPON_RIGHT].Type != -1 && pItem[EQUIPMENT_WEAPON_RIGHT].Type == -1)
	{
		Hero->Weapon[0].Level = 0;
	}

	if (pItem[NEW_EQUIPMENT_WEAPON_LEFT].Type != -1 && pItem[EQUIPMENT_WEAPON_LEFT].Type == -1)
	{
		Hero->Weapon[1].Level = 0;
	}

	for (int i = BODYPART_HELM; i < BODYPART_BOOTS + 1; i++)
	{
		if (pItem[i+241].Type != -1 && pItem[i+1].Type == -1)
		{
