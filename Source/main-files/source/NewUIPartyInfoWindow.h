...
namespace SEASON3B
{
...
#if CLIENT_VERSION >= 1001
			IMAGE_PARTY_BACK_VOID = BITMAP_NEW_DEFAULT_WINDOW_BACK, //"newui_repair_00.tga"
			IMAGE_PARTY_FRAME = BITMAP_NEW_FRAME_BOX_LARGE, //"newui_repair_00.tga"
#endif
		};		
	...
	private:
		...
		CCustomButtons				m_BtnExit;							// 파티창 나가기버튼
		CCustomButtons				m_BtnPartyExit[MAX_PARTYS];			// 파티탈퇴버튼
#endif
