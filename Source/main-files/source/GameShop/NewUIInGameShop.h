...
namespace SEASON3B
{
	...
	private:
		enum INGAMESHOP_TEXT_INFO
		{
			...
			TEXT_IGS_STORAGE_NAME_POS_X = 482,	// 보관함제목 - 이름
			TEXT_IGS_STORAGE_NAME_POS_Y = 130,
			TEXT_IGS_STORAGE_NAME_WIDTH = 96,
			TEXT_IGS_STORAGE_TIME_POS_X = 582,	// 보관함제목 - 기간
			TEXT_IGS_STORAGE_TIME_WIDTH = 34,
#endif
...
#elif CLIENT_VERSION >= 1001
			IMAGE_IGS_VIEWDETAIL_BTN_WIDTH = 52,		// View Detail Button
			IMAGE_IGS_VIEWDETAIL_BTN_HEIGHT = 18,
			IMAGE_IGS_BACK_WIDTH = 640,		// InGameShop Back
			IMAGE_IGS_BACK_HEIGHT = 405,
#endif
...
#elif CLIENT_VERSION >= 1001
		CVoidMuRadioGroupButton	m_ZoneButton;
		CVoidMuRadioGroupButton	m_CategoryButton;
		CVoidMuRadioGroupButton	m_ListBoxTabButton;

		CCustomButtons	m_ViewDetailButton[INGAMESHOP_DISPLAY_ITEMLIST_SIZE];
		CCustomButtons	m_CashGiftButton;
		CCustomButtons	m_CashChargeButton;
		CCustomButtons	m_CashRefreshButton;
		CCustomButtons	m_UseButton;
		CCustomButtons	m_PrevButton;
		CCustomButtons	m_NextButton;
		CCustomButtons	m_CloseButton;
		CCustomButtons	m_StoragePrevButton;
		CCustomButtons	m_StorageNextButton;
#endif
