...
public:
	...
	void SetGuild(int iPlayerNum, char* guildName);

	char * GetDuelPlayerID(int iPlayerNum);
	int GetScore(int iPlayerNum);
	char * GetGuild(int iPlayerNum);
...
public:
	...
	BOOL GetFighterRegenerated2() { return m_bRegenerated2; }
	void SetFighterRegenerated(BOOL bFlag) { m_bRegenerated = bFlag; }
	void SetFighterRegenerated2(BOOL bFlag) { m_bRegenerated2 = bFlag; }
