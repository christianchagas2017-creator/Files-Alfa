...
extern int ItemKey;
extern bool g_bGMObservation;	//CHARACTERNAME
extern bool g_bGMNOObservation; //UNCHARACTERNAME
extern bool g_bCustomTitle;		//CUSTOM TITLE
extern bool g_bCustomColor;		//CUSTOM COLOR CHAT
