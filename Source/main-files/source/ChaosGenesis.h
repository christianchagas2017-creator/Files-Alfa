...
namespace SEASON3B
{
	...
	public:
		enum IMAGE_LIST
		{
			IMAGE_GENESISMIXINVENTORY_BACK_VOID = BITMAP_NEW_DEFAULT_WINDOW_BACK,
			IMAGE_GENESISMIXINVENTORY_MIXBTN = BITMAP_INTERFACE_NEW_MIXINVENTORY_BEGIN,
			IMAGE_GENESISMIXINVENTORY_SCROLL_BACK = BITMAP_NEW_SCROLL_BACK,
			IMAGE_GENESISMIXINVENTORY_SCROLL_MIDDLE
		};
