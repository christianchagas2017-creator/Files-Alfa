...
namespace SEASON3B
{
...
#if CLIENT_VERSION >= 1001
			IMAGE_INVENTORY_BACK_VOID = BITMAP_NEW_DEFAULT_WINDOW_BACK, //"newui_repair_00.tga"
			IMAGE_INVENTORY_PREVIOUS = BITMAP_NEW_ARROW_LEFT,
			IMAGE_INVENTORY_NEXT,
			IMAGE_INVENTORY_ELEMENTSLOT1 = BITMAP_NEW_ELEMENTSLOT,
			IMAGE_INVENTORY_ELEMENTSLOT2,
			IMAGE_INVENTORY_ELEMENTSLOT3,
			IMAGE_INVENTORY_ELEMENTSLOT4,
#endif
	...
	private:
		...
		EQUIPMENT_ITEM m_EquipmentSlots[MAX_NEW_EQUIPMENT_INDEX];
		...
		CCustomButtons m_BtnMyShop;
		CCustomButtons m_BtnPrev;
		CCustomButtons m_BtnNext;
		CCustomButtons m_BtnHideTradeX;
#endif
	...
	public:
		...
		bool UpdateVisual();
		void Render3DItem();
		bool CheckRenderItensVisual();
		void RenderItemVisualToolTip(int iSlotIndex);
		bool CheckTooltipItensVisual(int iSlotIndex);
		// 
