...
void CNewUIEmpireGuardianNPC::LoadImages()
{
	...
	//btn
	LoadBitmap("Interface\\btn_small.jpg", IMAGE_EMPIREGUARDIAN_NPC_BTN, GL_LINEAR);

	//line
	LoadBitmap("Interface\\division_bar.tga", IMAGE_EMPIREGUARDIAN_NPC_LINE, GL_LINEAR);
#endif
}
