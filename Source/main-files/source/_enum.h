...
namespace SEASON3B
{
	enum INTERFACE_LIST
	{
		...
		INTERFACE_MUCOLLECTOR,
		INTERFACE_CHAOSGENESIS,
		INTERFACE_TRADEX,
		INTERFACE_END,
...
enum
{
	...
	MODEL_NEW_TRANSFORM = (MODEL_MASK_HELM + MAX_ITEM_INDEX + 10000),

	//NOVOS
	MODEL_FENRIR_THUNDER2 = (MODEL_NEW_TRANSFORM + 100),
	MAX_MODELS,
};
//object end
...
enum
{
	...
	PLAYER_FENRIR_SKILL_VITALITY,		//FENRIR BK BUFF
	PLAYER_FENRIR_SKILL_FURY_STRIKE,	//FENRIR BK RAGEBLOW
	PLAYER_DRAGON_STOP,					//DRAGON PARADO
	PLAYER_DRAGON_RUN,					//DRAGON ANDANDO
	PLAYER_FENRIR_DEFENSE1,				//FENRIR BK SHIELD
	PLAYER_FENRIR__SKILL_WHEEL,			//FENRIR BK TS
	PLAYER_STOP_MALE_NEW,
