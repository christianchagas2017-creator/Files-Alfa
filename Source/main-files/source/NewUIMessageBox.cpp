...
{
	float _fWidth = gWideScreen.g_WideWindowWidth, _fHeight = gWideScreen.g_WideWindowHeight;
...
void SEASON3B::CNewUIMessageBoxMng::LoadImages()
{
	...
	LoadBitmap("Interface\\btn_large.jpg", IMAGE_MSGBOX_BTN_EMPTY, GL_LINEAR);
	LoadBitmap("Interface\\messagebox_top.tga", IMAGE_MSGBOX_TOP, GL_LINEAR);
	LoadBitmap("Interface\\messagebox_middle.tga", IMAGE_MSGBOX_MIDDLE, GL_LINEAR);
	LoadBitmap("Interface\\messagebox_bottom.tga", IMAGE_MSGBOX_BOTTOM, GL_LINEAR);
	LoadBitmap("Interface\\newui_msgbox_back.jpg", IMAGE_MSGBOX_BACK, GL_LINEAR);
	LoadBitmap("Interface\\newui_Message_Line.tga", IMAGE_MSGBOX_LINE, GL_LINEAR);
	LoadBitmap("Interface\\messagebox_top_2.tga", IMAGE_MSGBOX_TOP_TITLEBAR, GL_LINEAR);
	LoadBitmap("Interface\\newui_separate_line.jpg", IMAGE_MSGBOX_SEPARATE_LINE, GL_LINEAR);
	LoadBitmap("Interface\\btn_medium.jpg", IMAGE_MSGBOX_BTN_OK, GL_LINEAR);
	LoadBitmap("Interface\\btn_medium.jpg", IMAGE_MSGBOX_BTN_CANCEL, GL_LINEAR);
	LoadBitmap("Interface\\btn_medium.jpg", IMAGE_MSGBOX_BTN_CLOSE, GL_LINEAR);
	LoadBitmap("Interface\\btn_medium.jpg", IMAGE_MSGBOX_BTN_EMPTY_SMALL, GL_LINEAR);
	LoadBitmap("Interface\\btn_large.jpg", IMAGE_MSGBOX_BTN_EMPTY_BIG, GL_LINEAR);
	LoadBitmap("Interface\\btn_small.jpg", IMAGE_MSGBOX_BTN_EMPTY_VERY_SMALL, GL_LINEAR);
	LoadBitmap("Interface\\btn_large_decor.jpg", IMAGE_MSGBOX_BTN_EMPTY_DECOR, GL_LINEAR);
