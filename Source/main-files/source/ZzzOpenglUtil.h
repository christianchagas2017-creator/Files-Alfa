...
void RenderColorRadius(float x, float y, float width, float height, float alpha = 0.f, int flag = 0, float radius = 0.f);
...
void RenderBitmapScale(int Texture,float x,float y,float Width,float Height,float u=0.f,float v=0.f,float uWidth=1.f,float vHeight=1.f,bool Scale=true,bool StartScale=true,float Alpha = 0.f);
