...
void CLuaGameServer::UpdateTopKill()
{
	...
	lua_pushnumber(L, gServerInfo.m_CounterItemTopSerial);
	lua_pushnumber(L, gServerInfo.m_CounterItemTopKills);
...
int CLuaGameServer::CheckPersonalShopValue(int aIndex, int targetIndex, int slot)
{
	if (this->m_Reloading)
	{
		return 0;
...
void CLuaGameServer::PersonalShopDecreaseValue(int aIndex, int value1, int value2, int value3, int value4)
{
	if (this->m_Reloading)
	{
		return;
	...
	lua_pushnumber(L, value3);
	lua_pushnumber(L, value4);
...
void CLuaGameServer::PersonalShopAddValue(int aIndex, int value1, int value2, int value3, int value4)
{
	if (this->m_Reloading)
	{
		return;
