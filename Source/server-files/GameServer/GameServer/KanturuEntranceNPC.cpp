...
void CKanturuEntranceNPC::CGKanturuEnterRecv(int aIndex) // OK
{
	...
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BossMapMove ] Error - State(%d) Character[%s][%s]",gKanturu.GetKanturuState(),lpObj->Account,lpObj->Name);
}
