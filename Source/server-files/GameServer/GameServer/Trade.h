...
public:
	...
	void GCTradeResponseSend(int aIndex,BYTE response,char* name,int level,int GuildNumber, BYTE TradeX = 0);
	...
	void GCTradeOkButtonSend(int aIndex,BYTE flag, BYTE tradeX = 0);
	void GCTradeResultSend(int aIndex,BYTE result, BYTE tradeX = 0);
