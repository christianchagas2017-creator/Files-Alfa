...
{
	gLog.Output(LOG_EVENT,"[ RAKLION ] State(%d) -> IDLE",this->m_RaklionState);
...
{
	gLog.Output(LOG_EVENT,"[ RAKLION ] State(%d) -> NOTIFY1",this->m_RaklionState);
...
{
	gLog.Output(LOG_EVENT,"[ RAKLION ] State(%d) -> STANDBY",this->m_RaklionState);
...
{
	gLog.Output(LOG_EVENT,"[ RAKLION ] State(%d) -> NOTIFY2",this->m_RaklionState);
#ifdef GLOBAL_DASHBOARD
	gNotice.GCNoticeSendToDash(0, gMessage.GetMessage(320),(((this->m_BossZoneCloseDelay/60)==0)?1:(this->m_BossZoneCloseDelay/60)));
#else
...
{
	gLog.Output(LOG_EVENT,"[ RAKLION ] State(%d) -> READY",this->m_RaklionState);
...
{
	gLog.Output(LOG_EVENT,"[ RAKLION ] State(%d) -> START_BATTLE",this->m_RaklionState);
...
{
	gLog.Output(LOG_EVENT,"[ RAKLION ] State(%d) -> NOTIFY3",this->m_RaklionState);
#ifdef GLOBAL_DASHBOARD
	gNotice.GCNoticeSendToDash(0, gMessage.GetMessage(321));
#else
...
{
	gLog.Output(LOG_EVENT,"[ RAKLION ] State(%d) -> CLOSE_DOOR",this->m_RaklionState);
...
{
	gLog.Output(LOG_EVENT,"[ RAKLION ] State(%d) -> ALL_USER_DIE",this->m_RaklionState);
...
{
	gLog.Output(LOG_EVENT,"[ RAKLION ] State(%d) -> NOTIFY4",this->m_RaklionState);

	this->m_BossZoneOpenMSec = GetTickCount();
#ifdef GLOBAL_DASHBOARD
	gNotice.GCNoticeSendToDash(0, gMessage.GetMessage(323),(((this->m_BossZoneOpenDelay/60)==0)?1:(this->m_BossZoneOpenDelay/60)));
#else
...
{
	gLog.Output(LOG_EVENT,"[ RAKLION ] State(%d) -> END",this->m_RaklionState);
	...
	this->ClearData();
#ifdef GLOBAL_DASHBOARD
	gNotice.GCNoticeSendToDash(0, gMessage.GetMessage(324));
#else
...
#ifdef GLOBAL_DASHBOARD
		gNotice.GCNoticeSendToDash(0, gMessage.GetMessage(322),lpTarget->Name);
#else
...
void CRaklion::BossEggRegenAll() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ] [ BossEggRegen ] : BossEgg(%d ea)",this->GetBossEggCount());
}
...
void CRaklion::BossEggDeleteAll() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ] [ BossEggDelete ] : BossEgg(%d ea)",this->GetBossEggCount());
}
