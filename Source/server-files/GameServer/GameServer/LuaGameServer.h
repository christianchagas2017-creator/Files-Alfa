...
public:
	...
	int CheckPersonalShopValue(int aIndex, int targetIndex, int slot);
	void PersonalShopDecreaseValue(int aIndex, int value1, int value2, int value3, int value4);
	void PersonalShopAddValue(int aIndex, int value1, int value2, int value3, int value4);
