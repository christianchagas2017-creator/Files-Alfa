...
void CRaklionSelupan::SelupanAct_FirstSkill() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ FirstSkill ] Skill Using : Index(%d) %s",aIndex,gObj[aIndex].Name);
}
...
void CRaklionSelupan::SelupanAct_PoisonAttack() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ PoisonAttack ] Skill Using : Index(%d) %s",aIndex,gObj[aIndex].Name);
}
...
void CRaklionSelupan::SelupanAct_IceStorm() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ IceStorm ] Skill Using : Index(%d) %s",aIndex,gObj[aIndex].Name);
}
...
void CRaklionSelupan::SelupanAct_IceStrike() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ IceStrike ] Skill Using : Index(%d) %s",aIndex,gObj[aIndex].Name);
}
...
void CRaklionSelupan::SelupanAct_SummonMonster() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ SummonMonster ] Skill Using : Index(%d) %s",aIndex,gObj[aIndex].Name);
}
...
void CRaklionSelupan::SelupanAct_Heal() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ Heal ] Skill Using : Index(%d) %s",aIndex,gObj[aIndex].Name);
}
...
void CRaklionSelupan::SelupanAct_Freeze() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ Freeze ] Skill Using : Index(%d) %s",aIndex,gObj[aIndex].Name);
}
...
void CRaklionSelupan::SelupanAct_Teleport() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ Teleport ] Skill Using : Index(%d) %s",aIndex,gObj[aIndex].Name);
}
...
void CRaklionSelupan::SelupanAct_Invincibility() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ Invincibility ] Skill Using : Index(%d) %s",aIndex,gObj[aIndex].Name);
}
...
void CRaklionSelupan::SelupanAct_BerserkCansel() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ Berserk Cancel ] MinDamage(%d) Damage(%d~%d)",gObj[aIndex].PhysiDamageMin,gObj[aIndex].PhysiDamageMin,gObj[aIndex].PhysiDamageMax);
}
...
void CRaklionSelupan::SelupanAct_Berserk1() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ Berserk1 ] Skill Using : Index(%d) Damage(%d~%d)",aIndex,gObj[aIndex].PhysiDamageMin,gObj[aIndex].PhysiDamageMax);
}
...
void CRaklionSelupan::SelupanAct_Berserk2() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ Berserk2 ] Skill Using : Index(%d) Damage(%d~%d)",aIndex,gObj[aIndex].PhysiDamageMin,gObj[aIndex].PhysiDamageMax);
}
...
void CRaklionSelupan::SelupanAct_Berserk3() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ Berserk3 ] Skill Using : Index(%d) Damage(%d~%d)",aIndex,gObj[aIndex].PhysiDamageMin,gObj[aIndex].PhysiDamageMax);
}
...
void CRaklionSelupan::SelupanAct_Berserk4() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ][ Berserk4 ] Skill Using : Index(%d) Damage(%d~%d)",aIndex,gObj[aIndex].PhysiDamageMin,gObj[aIndex].PhysiDamageMax);
}
...
void CRaklionSelupan::DeleteSummonMonster() // OK
{
	...
	gLog.Output(LOG_EVENT,"[ RAKLION ] [ DeleteSummonMonster ] Delete All SummonMonster");
}
