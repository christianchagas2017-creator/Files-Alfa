...
void CItem::Clear() // OK
{
	...
	this->m_Value = 0;
	this->m_PShopValue1 = 0;
	this->m_PShopValue2 = 0;
	this->m_PShopValue3 = 0;
	this->m_PShopValue4 = 0;
	...
	this->m_LoadDeathSystem = 0;
	this->m_DeathSystemKills = 0;
	this->m_DeathSystemTop = 0;
...
char* CItem::GetName()
{
	...
	return &ItemInfo.Name[0];
}

bool CItem::IsExtItem()
{
#if(GAMESERVER_UPDATE>=201)
	if (this->m_Index == GET_ITEM(13, 37))
	{
		return 0;
	}
#endif
