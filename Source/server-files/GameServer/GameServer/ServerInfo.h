...
public:
	char m_MySQLServer[32];
	char m_MySQLDatabase[32];
	char m_MySQLUser[32];
	char m_MySQLPass[32];
	...
	int m_UserLoggoutTimer;
	int m_MonsterHealthBarSwitch;
	int m_PlayerKillStaff;
	int m_StaffKillPlayer;
	int m_StaffKillStaff;
	int m_ComboSwitch;
	int m_NonPK;
	int m_PKLimitFree;
	int m_PKDownTime1;
	...
	int m_CommandPKClearSwitch;
	int m_CommandPKClearEnable[MAX_ACCOUNT_LEVEL];
	int m_CommandPKClearMoney[MAX_ACCOUNT_LEVEL];
	int m_CommandMoneySwitch;
	int m_CommandMoneyEnable[MAX_ACCOUNT_LEVEL];
	int m_CommandChangeSwitch;
	...
	int m_CommandMasterResetSwitch;
	...
	int m_CommandGMMoveSwitch;
	int m_CommandGMMoveGameMasterLevel;
	int m_CommandGMPostSwitch;
	int m_CommandGMPostGameMasterLevel;
	int m_CommandTrackSwitch;
	int m_CommandTrackGameMasterLevel;
	int m_CommandTraceSwitch;
	int m_CommandTraceGameMasterLevel;
	int m_CommandDisconnectSwitch;
	int m_CommandDisconnectGameMasterLevel;
	int m_CommandFireworksSwitch;
	int m_CommandFireworksGameMasterLevel;
	int m_CommandMakeSwitch;
	int m_CommandMakeGameMasterLevel;
	int m_CommandSkinSwitch;
	int m_CommandSkinGameMasterLevel;
	int m_CommandSetMoneySwitch;
	int m_CommandSetMoneyGameMasterLevel;
	int m_CommandNoticeSwitch;
	int m_CommandNoticeGameMasterLevel;
	int m_CommandHideSwitch;
	int m_CommandHideGameMasterLevel;
	int m_BlockTwisterSlash;
	int m_TwisterSlashConstA;
	int m_TwoWeaponsDamageMinConstA;
	int m_TwoWeaponsDamageMaxConstA;
	int m_DisablePushSkills;
	...
	int m_CounterItemTopSerial;
	int m_CounterItemTopKills;
