...
struct PMSG_WAREHOUSE_BUY_RECV
{
...
struct PMSG_WAREHOUSE_COST_SEND
{
	PBMSG_HEAD header; // C1:83
	char coinname[36];
	DWORD value;
...
public:
	...
	void CGWarehouseChangeRecv(PMSG_WAREHOUSE_CHANGE_RECV* lpMsg,int aIndex);
	void CGWarehouseBuyRecv(int aIndex);
	void CGWarehouseBuyCostRecv(int aIndex);
	...
	void GDWarehouseInfoSend(int aIndex);
};
