...
#define MAX_OBJECT 14000
#define MAX_OBJECT_MONSTER 12000
#define MAX_OBJECT_USER 1000

#else

#define MAX_OBJECT 14000
#define MAX_OBJECT_MONSTER 1200
#define MAX_OBJECT_USER 1000
...
struct OBJECTSTRUCT
{
	...
	BYTE* TradeXMap;
	bool TradeXOk;
	DWORD TradeXTimeItem;
	bool UsingTradeX;
	BYTE TradeXState;
	char TradeXTarget[11];
	int CoinsRate;
	int CoinsExchange;
#endif

#ifdef CHAOS_MACHINE_GENESIS
	CItem* ChaosBoxGenesis;
	bool ChaosBoxGenesisUsing;
	bool ChaosBoxGenesisLock;
	bool ChaosBoxGenesisUsed;
...
#pragma pack()
	...
	//Pick
	bool m_CustomPickEnabled;

#ifdef FAIRPLAY
	int minuteCount;
	int expReceiveCount;
	int totalExpGained;
	DWORD startExpGainTick;
	DWORD lastExpGainTick;
	int lastExpGained;
	int LastMoneyObtained;
	int MoneyObtainedTotal;
#endif
};
