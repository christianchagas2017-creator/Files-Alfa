...
void CKanturuBattleOfMaya::ProcState_START1() // OK
{
	if(gKanturuMonsterMng.IsExistAliveMonster() == 0)
	{
		...
		gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] Success!! - DetailState:%d",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> NONE",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> STANBY1",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> NOTIFY1",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> START1",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> MAYA1",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> END_MAYA1",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> ENDCYCLE_MAYA1",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> STANBY2",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> START2",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> MAYA2",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> END_MAYA2",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> ENDCYCLE_MAYA2",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> STANBY3",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> START3",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> MAYA3",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> END_MAYA3",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> ENDCYCLE_MAYA3",this->m_BattleOfMayaState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> END",this->m_BattleOfMayaState);
	...
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] Success Value[%d]",this->GetSuccessValue());
}

void CKanturuBattleOfMaya::SetState_ENDCYCLE() // OK
{
	gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] State(%d) -> ENDCYCLE",this->m_BattleOfMayaState);
...
void CKanturuBattleOfMaya::CheckMayaBattleTime() // OK
{
	if(this->GetBattleSceneState() != -1 && this->m_BattleTimeInfo[this->m_SceneState].GetCondition() == 1 && this->GetSceneSuccessValue() == 0 && this->GetBattleOfMayaState() != KANTURU_MAYA_END && this->m_BattleTimeInfo[this->m_SceneState].IsTimeOut() != 0)
	{
		...
		gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] Fail!! TimeOut - DetailState:%d",this->m_BattleOfMayaState);
...
void CKanturuBattleOfMaya::CheckMayaBattleUser() // OK
{
	if(this->GetBattleOfMayaState() == KANTURU_MAYA_NOTIFY1 || this->GetBattleOfMayaState() == KANTURU_MAYA_START1 || this->GetBattleOfMayaState() == KANTURU_MAYA1 || this->GetBattleOfMayaState() == KANTURU_MAYA_START2 || this->GetBattleOfMayaState() == KANTURU_MAYA2 || this->GetBattleOfMayaState() == KANTURU_MAYA_START3 || this->GetBattleOfMayaState() == KANTURU_MAYA3)
	{
		if(gKanturuBattleUserMng.IsEmpty() != 0)
		{
			...
			gLog.Output(LOG_EVENT,"[ KANTURU ][ BattleOfMaya ] Fail!! All Battle User Die - DetailState:%d",this->m_BattleOfMayaState);
