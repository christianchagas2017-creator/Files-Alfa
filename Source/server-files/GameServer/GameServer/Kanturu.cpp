...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ] State(%d) -> NONE",this->m_KanturuState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ] State(%d) -> STANDBY",this->m_KanturuState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ] State(%d) -> BATTLE_OF_MAYA",this->m_KanturuState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ] State(%d) -> BATTLE_OF_NIGHTMARE",this->m_KanturuState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ] State(%d) -> TOWER_OF_REFINEMENT",this->m_KanturuState);
...
{
	gLog.Output(LOG_EVENT,"[ KANTURU ] State(%d) -> END",this->m_KanturuState);
...
void CKanturu::SetKanturuMapAttr(int level) // OK
{
	...
	gLog.Output(LOG_EVENT,"[ KANTURU ][ Map Attr Change ] Map(%d) State(%d) DetailState(%d)",level,this->GetKanturuState(),this->GetKanturuDetailState());
}
